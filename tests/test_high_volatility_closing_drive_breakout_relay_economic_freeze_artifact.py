...
FREEZE = Path(
    "results/high_volatility_closing_drive_breakout_relay_economic_evaluator_freeze_2026-08-11.json"
)
...
def test_hvcdbr_economic_freeze_is_outcome_blind_and_code_bound():
