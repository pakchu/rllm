...
from training import evaluate_high_volatility_macro_news_sentiment_dispersion_relay_gross9_novelty as novelty


def test_hvmnsd_novelty_evaluator_is_outcome_blind_and_frozen():
    source = Path(novelty.__file__).read_text()
    assert novelty.POLICY == "HVMNSD-24"
...
def test_hvmnsd_novelty_binds_predecessors():
