...
from training import evaluate_temporal_sign_persistence_imbalance_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "TSPI-12"
    ...
    assert economics.CONTROLS == ("body_count", "body_magnitude", "maximum_run", "direction_flip")
