...
from training import evaluate_high_volatility_realized_leverage_cross_moment_relay_economics as evaluator


def test_hvrlxc_evaluator_is_bound_and_empty_safe():
    assert evaluator.POLICY_ID == "HVRLXC-12"
