...
from training import evaluate_high_volatility_median_crossing_impulse_asymmetry_relay_economics as e


def test_evaluator_is_bound_and_empty_safe():
    assert e.POLICY_ID == "HVMCIA-8"
