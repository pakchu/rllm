...
from training import build_high_volatility_premium_quiescence_continuation_support as support
...
def test_primary_and_controls_use_frozen_gates() -> None:
    frame = pd.DataFrame({
        ...
        "premium_activity_rank": [0.2, 0.2, 0.3],
...
def test_clock_uses_next_day_0005_and_twelve_hours() -> None:
    frame = pd.DataFrame({
        ...
        "premium_total_variation": [1.0], "premium_activity_rank": [0.2],
...
def test_builder_queries_are_source_only() -> None:
    ...
    assert support.PREREG_SHA == "cbacf3f0695eef98d34e24bcd1ae585079b21354dcc419a31e6812df83458456"
