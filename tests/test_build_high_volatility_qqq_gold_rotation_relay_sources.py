...
from training import build_high_volatility_qqq_gold_rotation_relay_sources as builder
...
def test_parse_uses_only_raw_open_close():
    frame, metadata = builder.parse_payload(_payload("QQQ"), "QQQ")
...
def test_deterministic_gzip(tmp_path):
    frame, _ = builder.parse_payload(_payload("GLD"), "GLD")
