...
FREEZE = Path(
    "results/high_volatility_dual_half_signed_volume_persistence_relay_economic_evaluator_freeze_2026-08-10.json"
)
...
def test_hvdhsvpr_economic_freeze_is_outcome_blind_and_code_bound():
