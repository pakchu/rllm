...
from training import build_emerging_growth_volatility_rotation_relay_support as support


def test_egvrr_midrank_excludes_current():
...
def test_egvrr_clock_is_0935_new_york_with_twelve_hour_hold():
    ...
    frame = pd.DataFrame({
        ...
        "vxeem_minus_vxn_raw": [1.0], "btc_realized_variation": [0.1],
...
def test_egvrr_builder_is_outcome_blind():
