...
def _clock(entries, hold_hours=8, sides=None):
...
def test_disjoint_pair_passes_all_limits():
    candidate = _clock(["2024-01-01T00:05:00Z", "2024-01-03T00:05:00Z"], sides=[1, -1])
    comparator = _clock(["2024-01-02T12:00:00Z", "2024-01-04T12:00:00Z"])
...
def test_exact_overlap_fails():
    candidate = _clock(["2024-01-01T00:05:00Z", "2024-01-03T00:05:00Z"])
