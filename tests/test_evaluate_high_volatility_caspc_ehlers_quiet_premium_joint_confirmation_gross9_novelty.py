...
from training import evaluate_high_volatility_caspc_ehlers_quiet_premium_joint_confirmation_gross9_novelty as novelty
...
def test_frozen_controls_verify_all_hashes() -> None:
    ...
    assert registration["candidate_family_size"] == 1
