...
from training import evaluate_high_volatility_path_utility_random_forest_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVPRF-48"
