...
from training import evaluate_gross_oi_churn_release_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "GOICR-12"
    ...
    assert economics.CONTROLS == ("net_oi_tail_only", "gross_churn_without_cancellation", "late_price_escape_only", "one_decision_stale_churn", "direction_flip")
