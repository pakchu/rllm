import numpy as np
import pandas as pd
from training import build_high_volatility_trix_zero_cross_relay_support as s
...
def panel():
 return pd.DataFrame({"source_valid":[True]*6,"entry_side":[0,0,1,0,-1,0],"single_ema_side":[0,0,1,0,-1,0],"variation_rank":[.8,.8,.8,.8,.4,.8]})
def test_controls():
