...
from training import build_high_volatility_premium_activity_sponsorship_relay_support as support
...
def test_primary_and_controls_use_frozen_gates() -> None:
    frame = pd.DataFrame({
        ...
        "premium_activity_rank": [0.8, 0.8, 0.7],
...
def test_clock_uses_next_day_0005_and_twelve_hours() -> None:
    frame = pd.DataFrame({
        ...
        "premium_total_variation": [1.0], "premium_activity_rank": [0.8],
...
def test_builder_queries_are_source_only() -> None:
    ...
    assert support.PREREG_SHA == "d428a7065e47203e0daf9f99d2862280e9d147569fa5b737703338506802824d"
