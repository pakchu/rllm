...
from training import evaluate_cboe_skew_acceleration_dual_confirmation_relay_gross9_novelty as novelty
def test_cvskdmr_novelty_evaluator_is_outcome_blind_and_frozen():
