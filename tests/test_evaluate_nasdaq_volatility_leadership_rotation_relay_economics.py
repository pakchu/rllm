...
from training import evaluate_nasdaq_volatility_leadership_rotation_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    ...
    assert economics.FREEZE == Path(
        "results/nasdaq_volatility_leadership_rotation_relay_economic_evaluator_freeze_2026-08-10.json"
    )
...
def test_frozen_predecessor_artifact_hashes_are_exact():
    assert economics.PREREG_SHA == (
        "c091adf520e5f9b578922ef79f7a4c523da9b0964884bc523afbbe4a90ed4e6d"
    )
    assert economics.SUPPORT_SHA == (
        "17bf2b112b0685344769b9ff67cb5f70a2960cbe46fd444b9ee13e03b645f3c4"
    )
    assert economics.CLOCK_SHA == (
        "420ddb023fe837e189be0517a30eb1884204b15651c8cbc0b502ae748ca87ecd"
    )
    assert economics.NOVELTY_SHA == (
        "28f8f38682445889c0cab48c0b7c2f0d6a53fe98499a82ed0e735802338cc30d"
    )
...
def _bind_verify_inputs(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> dict:
    ...
    _write_json(prereg, {"policy_id": "NVLRR-12"})
