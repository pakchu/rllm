...
from training import evaluate_high_volatility_wide_range_body_continuation_relay_economics as e


def test_evaluator_is_bound_and_empty_safe():
    assert e.POLICY_ID == "HVWRBC-24"
    ...
    assert e.CONTROLS == (
        "no_wide_range_requirement",
        "no_variation_gate",
        "body_direction_only",
        "one_block_stale_prior_ranges",
        "direction_flip",
        "forced_long",
    )
