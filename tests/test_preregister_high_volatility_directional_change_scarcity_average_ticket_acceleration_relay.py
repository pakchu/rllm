...
from training import preregister_high_volatility_directional_change_scarcity_average_ticket_acceleration_relay as p


def test_hvdcs_ata_is_outcome_blind_singleton():
    result = p.build()
    assert result["policy_id"] == "HVDCSATA-8"
    ...
    assert result["research_boundary"]["exact_hvdcs_average_ticket_acceleration_intersection_incidence_or_outcomes_known"] is False
