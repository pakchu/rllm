...
from training import build_emerging_market_dollar_factor_relay_support as support
...
def test_controls_are_diagnostic_transformations():
    candidate = frame()
    assert support.CONTROLS == ("no_volatility_gate", "no_factor_tail", "raw_return_factor", "one_session_stale_factor", "direction_flip", "forced_long")
...
def test_emerging_market_dollar_orientation_is_frozen():
    assert support.DOLLAR_MULTIPLIER == {"USDMXN": 1.0, "USDINR": 1.0, "USDCNY": 1.0}
