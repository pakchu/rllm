...
FREEZE = Path(
    "results/high_volatility_wide_range_body_continuation_relay_economic_evaluator_freeze_2026-08-11.json"
)
...
def test_hvwrbc_economic_freeze_is_outcome_blind_and_code_bound():
