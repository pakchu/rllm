...
RESULT=Path("results/high_volatility_inside_auction_resolution_relay_gross9_novelty_2026-08-11.json")
def sha256(path):return hashlib.sha256(path.read_bytes()).hexdigest()
def test_hviarr_novelty_pass_is_frozen_blind():
 ...
 assert sha256(RESULT)=="99feb762d2302198b10e0a3911bca7028cfbaf2d5bbbec942057c9dbc9428436"
