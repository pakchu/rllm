import pandas as pd
from training import build_high_volatility_cash_led_median_return_shift_dominance_support as s
...
def test_smaller_same_sign_spot_shift_rejects_primary():assert s.confirm(primary(1),spot(.05)).empty
