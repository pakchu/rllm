...
import pandas as pd
from training import evaluate_high_volatility_london_fix_dollar_impulse_relay_economics as e
def test_bound_and_empty_safe():
 assert e.POLICY_ID=="HVLFX-12" and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==("no_volatility_gate","eurusd_only","one_session_stale_fix_impulse","direction_flip")
