from training import preregister_high_volatility_median_crossing_impulse_asymmetry_relay as p
def test_boundary():
 x=p.build();assert x["policy_id"]=="HVMCIA-8" and x["outcomes_opened"] is False and x["source_incidence_opened"] is False and x["gross9_rows_opened"] is False and x["singleton"] is True
