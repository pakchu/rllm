...
from training import evaluate_high_volatility_dominant_shock_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVDSR-12"
    ...
    assert economics.CONTROLS == ("no_dominant_share_gate", "no_variation_gate", "completed_day_return_side", "latest_maximum_tie_break", "one_day_stale_features", "direction_flip", "same_clock_forced_long")
