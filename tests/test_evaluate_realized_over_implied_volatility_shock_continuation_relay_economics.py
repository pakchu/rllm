...
from training import evaluate_realized_over_implied_volatility_shock_continuation_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
    assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest() == "b7fc7c91a800efe96a148817ee16b35fc051e710d1d737bd52cb164aec55d6be"
