...
from training import evaluate_high_volatility_gradient_boosting_regression_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVGBR-72"
