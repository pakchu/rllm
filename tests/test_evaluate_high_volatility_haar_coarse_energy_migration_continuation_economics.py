...
from training import evaluate_high_volatility_haar_coarse_energy_migration_continuation_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVHCEM-12"
    ...
    assert economics.CONTROLS == ("no_migration_gate", "no_volatility_gate", "coarse_share_level", "one_boundary_stale_migration", "direction_flip")
