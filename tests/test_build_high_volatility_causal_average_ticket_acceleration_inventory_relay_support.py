...
import numpy as np
import pandas as pd
from training import build_high_volatility_causal_average_ticket_acceleration_inventory_relay_support as s
...
def test_clock_side_follows_completed_return(monkeypatch) -> None:
    ...
    panel=pd.DataFrame({"decision_time":decisions,"feature_available_time":decisions,"eligible":[True,True],"oi_change":[.01,.02],"first_half_quote_turnover":[1000.,1200.],"second_half_quote_turnover":[1800.,2200.],"first_half_trade_count":[100.,100.],"second_half_trade_count":[150.,180.],"first_half_average_ticket":[10.,12.],"second_half_average_ticket":[12.,12.222222],"completed_return":[.04,-.05],"average_ticket_acceleration":[.1823,.01835],"average_ticket_acceleration_rank":[.8,.9],"realized_variation":[.1,.1],"variation_rank":[.7,.8]})
