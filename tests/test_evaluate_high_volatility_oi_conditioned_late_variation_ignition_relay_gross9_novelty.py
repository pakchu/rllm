...
from training import evaluate_high_volatility_oi_conditioned_late_variation_ignition_relay_gross9_novelty as novelty


def test_hvoilvi_novelty_evaluator_is_outcome_blind_and_frozen():
    source = Path(novelty.__file__).read_text()
    assert novelty.POLICY == "HVOILVI-12"
...
def test_hvoilvi_novelty_binds_predecessors():
