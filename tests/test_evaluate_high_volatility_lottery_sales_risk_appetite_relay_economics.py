...
def test_hvlsra_evaluator_is_bound_and_empty_safe():
    assert evaluator.POLICY_ID == "HVLSRA-24"
    ...
    assert evaluator.CONTROLS == (
        ...
        "sales_direction_flip",
        "one_draw_stale_sales_change",
        "weekday_balanced_change",
