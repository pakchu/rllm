...
from training import evaluate_scheduled_trend_concordance_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "STCR-72"
    ...
    assert economics.CONTROLS == ("three_day_only", "fourteen_day_only", "direction_flip")
