...
def test_bound_empty_and_strict():
 assert e.POLICY_ID=='HVTCEC-24' and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==('no_variation_gate','no_top_two_concordance','one_decision_stale_committee','direction_flip','same_clock_forced_long')
