...
from training import evaluate_confirmation_ladder_impulse_reversal_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "CLIRR-6"
    ...
    assert economics.CONTROLS == ("direction_reversal_only", "acceleration_only", "one_anchor_stale_ladder", "direction_flip")
