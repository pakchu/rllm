...
def test_ccvdar_novelty_evaluator_is_outcome_blind_and_frozen():
 source=Path(novelty.__file__).read_text()
 assert novelty.POLICY=="CCVDAR-6" and novelty.LIMITS["one_to_one_6h_max_matched_share"]==.35 and novelty.LIMITS["occupied_5m_bar_jaccard"]==.25
