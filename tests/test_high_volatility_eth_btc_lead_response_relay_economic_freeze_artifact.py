...
FREEZE = Path(
    "results/high_volatility_eth_btc_lead_response_relay_economic_evaluator_freeze_2026-08-10.json"
)
...
def test_hveblr_economic_freeze_is_outcome_blind_and_code_bound():
