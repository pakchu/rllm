...
RESULT=Path("results/high_volatility_quartile_median_staircase_relay_gross9_novelty_2026-08-10.json")
def sha256(path):return hashlib.sha256(path.read_bytes()).hexdigest()
def test_hvqmsr_novelty_pass_is_frozen_blind():
 ...
 assert sha256(RESULT)=="51b9edb46eaeb4a31d473149060f791c69147924ed2d16064007a59cfd1df4ed"
