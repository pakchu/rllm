...
import copy
import pytest
from training import preregister_high_volatility_causal_extreme_displacement_reversal as p
...
def test_singleton_mechanism_and_fixed_policy() -> None:
    ...
    assert value["policy_id"]=="HVCEDR-24"
    assert value["candidate_family"]==["HVCEDR-24"]
