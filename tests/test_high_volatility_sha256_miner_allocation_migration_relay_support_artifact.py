...
RESULT = Path(
    "results/high_volatility_sha256_miner_allocation_migration_relay_support_2026-08-10.json"
)
SOURCE = Path(
    "data/high_volatility_sha256_miner_allocation_migration_relay_sources_2023_2026/manifest.json"
)


def test_terminal_source_support_artifact_is_sealed() -> None:
    assert hashlib.sha256(RESULT.read_bytes()).hexdigest() == (
        "201cce3a10e70f8c7871377b698cc85877385f1de4d573269dd3335acd2ffc8c"
    )
...
def test_complete_pair_source_is_sealed() -> None:
    assert hashlib.sha256(SOURCE.read_bytes()).hexdigest() == (
        "06291127ecf25efd291136a6604f0fe27a965dbce39344e8b04fcdfb8382299a"
    )
