...
from training import evaluate_emerging_safe_haven_volatility_rotation_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    ...
    assert economics.FREEZE == Path(
        "results/emerging_safe_haven_volatility_rotation_relay_economic_evaluator_freeze_2026-08-10.json"
    )
...
def test_frozen_predecessor_artifact_hashes_are_exact():
    assert economics.PREREG_SHA == (
        "7b7cba82f94709c412f9aa7fdb9ee27f5ff378783df88d9baa23c0766e15ad50"
    )
    assert economics.SUPPORT_SHA == (
        "606f5bff8a0694e3377b9ae5b534ec0761c9528f0ced1c28595aa673be249599"
    )
    assert economics.CLOCK_SHA == (
        "e4bbedf0bf5abb72ca7bc536bc45df458d980f02ba26b78bb17aca5f39290a8f"
    )
    assert economics.NOVELTY_SHA == (
        "59a909749229952ec73f20970439548288ced112ec865cd2dbda5c366dfb56a3"
    )
...
def _bind_verify_inputs(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> dict:
    ...
    _write_json(prereg, {"policy_id": "ESVRR-12"})
