...
FREEZE = Path(
    "results/high_volatility_failed_auction_escape_reversal_relay_economic_evaluator_freeze_2026-08-11.json"
)
...
def test_hvfaer_economic_freeze_is_outcome_blind_and_code_bound():
