...
from training import build_high_volatility_energy_commodity_return_spillover_relay_support as b
    ...
    frame = pd.DataFrame(
        {
            ...
            "uso_intraday_return": [-0.01], "bno_intraday_return": [-0.01],
            "ung_intraday_return": [0.02], "oil_return": [-0.01], "spillover_score": [0.03],
            "spillover_score_z": [1.5], "inverse_oil_z": [1.5], "natural_gas_z": [1.5],
