...
def test_bound_and_empty_safe():
 assert e.POLICY_ID=="HVHHM-C10-N5-8" and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==("no_variation_gate","morphology_only_lower_wick_direction","no_near_context","one_hour_stale_pattern","direction_flip","forced_long")
