...
from training import build_high_volatility_taker_flow_decay_acceptance_continuation_support as s
...
def test_clock_follows_accepted_direction(monkeypatch):
    ...
    panel = pd.DataFrame({
        ...
        "first_half_flow_imbalance": [0.2, -0.2],
        "second_half_flow_imbalance": [0.1, -0.1],
