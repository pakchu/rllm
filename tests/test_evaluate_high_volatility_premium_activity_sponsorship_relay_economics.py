...
from training import evaluate_high_volatility_premium_activity_sponsorship_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVPASR-12"
    ...
    assert economics.CONTROLS == ("no_premium_activity_gate", "no_btc_variation_gate", "one_day_stale_features", "direction_flip", "same_clock_forced_long")
