...
def test_hvmrr_novelty_artifact_passes_without_oos_outcomes():
    assert hashlib.sha256(novelty.OUTPUT.read_bytes()).hexdigest() == "9af96f6ea4ba5d2a6755f78721994a209250640d3b0aeb4ae35db3ecf94fec42"
