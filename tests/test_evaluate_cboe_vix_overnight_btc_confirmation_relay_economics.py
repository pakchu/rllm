...
import pandas as pd
from training import evaluate_cboe_vix_overnight_btc_confirmation_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
 assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest()=="7e1f51f62b05735cb7c11b37fc75252f6a0f20c5fe53121024901c47e723713e"
