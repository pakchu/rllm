...
def test_bound_and_empty_safe():
 assert e.POLICY_ID=="HVCACJP-6" and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==("no_variation_gate","three_of_six_cojump","btc_confirmation","one_bar_stale_cojump","direction_flip","forced_long")
