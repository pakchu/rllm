...
from training import build_eia_petroleum_stock_breadth_support as support
...
def test_real_support_passes_without_opening_outcomes(tmp_path: Path) -> None:
    ...
    assert report["source_rows"] == 259
    assert report["source_complete_rows"] == 258
...
def test_clock_summaries_and_controls_are_frozen(tmp_path: Path) -> None:
    ...
    assert primary["stage2_2023"] == {
        ...
        "longs": 6,
        "shorts": 7,
        "max_single_month_count": 2,
        "max_single_month_share": 2 / 13,
    }
