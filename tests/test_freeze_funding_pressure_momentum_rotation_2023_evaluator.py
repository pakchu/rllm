...
from training import freeze_funding_pressure_momentum_rotation_2023_evaluator as freeze


def test_manifest_declares_zero_outcome_access() -> None:
    payload = freeze.build_manifest("a" * 40, clock_rows=99)
...
def test_manifest_tampering_is_detected() -> None:
    payload = freeze.build_manifest("b" * 40, clock_rows=99)
