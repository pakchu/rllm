...
from training import build_high_volatility_realized_skew_open_interest_sponsorship_relay_support as support


def frame():
    return pd.DataFrame({"source_valid": [True] * 5, "oi_start": [100.] * 5, "oi_end": [110.] * 5, "oi_change": [.1] * 5, "realized_variation": [1.0] * 5, "realized_skew": [0.2, -0.3, 0.1, 0.4, -0.2], "raw_third_moment": [2.0, -3.0, 1.0, 4.0, -2.0], "variation_rank": [0.8, 0.7, 0.9, 0.5, 0.8], "absolute_skew_rank": [0.8, 0.9, 0.6, 0.9, 0.8]})


def test_primary_follows_oi_sponsored_extreme_skew():
