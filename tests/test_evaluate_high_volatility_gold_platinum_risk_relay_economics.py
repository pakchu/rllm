...
import pandas as pd
from training import evaluate_high_volatility_gold_platinum_risk_relay_economics as e
def test_bound_and_empty_safe():
 assert e.POLICY_ID=="HVAUPTR-24" and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==("no_btc_volatility_gate","gld_only","inverse_pplt_only","one_session_stale_impulse","direction_flip")
