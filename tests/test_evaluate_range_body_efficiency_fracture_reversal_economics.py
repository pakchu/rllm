...
from training import evaluate_range_body_efficiency_fracture_reversal_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "RBEFR-8"
    ...
    assert economics.CONTROLS == ("raw_range_variance_tail", "inverse_body_variance_tail", "one_decision_stale_fracture", "direction_flip")
