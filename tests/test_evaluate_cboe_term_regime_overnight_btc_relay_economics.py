...
import pandas as pd
from training import evaluate_cboe_term_regime_overnight_btc_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
 assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest()=="0c21de95d23a00547098cc1148b88b9b4124bf49675953025df60ed8c5cb97b1"
