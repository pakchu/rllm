...
from training import evaluate_high_volatility_price_level_occupation_relay_economics as e


def test_evaluator_is_bound_and_empty_safe():
    assert e.POLICY_ID == "HVPLO-8"
    ...
    assert e.CONTROLS == (
        "no_occupation_tail",
        "no_variation_gate",
        "median_level_displacement",
        "one_boundary_stale_occupation",
        "direction_flip",
