from training import preregister_high_volatility_failed_auction_escape_reversal_relay as p
def test_boundary():
 x=p.build();assert x["policy_id"]=="HVFAER-8" and x["as_of_date"]=="2026-08-11" and x["outcomes_opened"] is False and x["source_incidence_opened"] is False and x["gross9_rows_opened"] is False and x["singleton"] is True
