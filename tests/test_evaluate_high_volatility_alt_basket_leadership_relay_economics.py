...
from training import evaluate_high_volatility_alt_basket_leadership_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    ...
    assert economics.FREEZE == Path(
        "results/high_volatility_alt_basket_leadership_relay_economic_evaluator_freeze_2026-08-10.json"
    )
...
def test_frozen_predecessor_artifact_hashes_are_exact():
    assert economics.PREREG_SHA == (
        "285d84214e03743e6120380016fbaf35cee4978fedb3d209359b4e91efd7cc76"
    )
    assert economics.SUPPORT_SHA == (
        "cb5fa165abd58b1181352a712220739ec287af8390070007868cb17ef0418bb4"
    )
    assert economics.CLOCK_SHA == (
        "08a52e0609a8c40b6243b1b09810b858aef3b92e051a528b6be5a2353da5702f"
    )
    assert economics.NOVELTY_SHA == (
        "f997a9b3aebcfe7e096fa4c6abc524c14699953555ebd8959556030df8b8c710"
    )
...
def _bind_verify_inputs(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> dict:
    ...
    _write_json(prereg, {"policy_id": "HVABLR-6"})
