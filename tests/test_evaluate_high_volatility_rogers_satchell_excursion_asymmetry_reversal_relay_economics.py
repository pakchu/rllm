...
def test_bound_and_empty_safe():
 assert e.POLICY_ID=="HVRSAR-8" and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==("no_asymmetry_tail","no_variation_gate","latest_bar_asymmetry","one_bar_stale_onset","direction_follow","forced_long")
