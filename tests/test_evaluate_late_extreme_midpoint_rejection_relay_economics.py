...
from training import evaluate_late_extreme_midpoint_rejection_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "LEMRR-16"
    ...
    assert economics.CONTROLS == ("no_midpoint_rejection", "close_location_only", "close_open_fade", "direction_flip")
