...
from training import evaluate_high_volatility_directional_variation_timing_migration_relay_economics as e


def test_evaluator_is_bound_and_empty_safe():
    assert e.POLICY_ID == "HVDVTM-8"
    ...
    assert e.CONTROLS == (
        "no_timing_tail",
        "no_variation_gate",
        "directional_variation_mass_asymmetry",
        "one_block_stale_timing",
        "direction_flip",
        "forced_long",
    )
