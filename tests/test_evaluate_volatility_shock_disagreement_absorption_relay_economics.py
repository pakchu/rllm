...
import pandas as pd
from training import evaluate_volatility_shock_disagreement_absorption_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
 assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest()=="a85f390a3008ee8c971459f22509159f59abfb65cecb1ee41fff5651759bfc2f"
