...
FREEZE = Path(
    "results/high_volatility_range_turnover_coupling_relay_economic_evaluator_freeze_2026-08-10.json"
)
...
def test_hvrtcr_economic_freeze_is_outcome_blind_and_code_bound():
