...
import pandas as pd
from training import evaluate_high_volatility_relative_vigor_crossover_relay_economics as e
def test_bound_and_empty_safe():
 ...
 assert e.CONTROLS==("no_variation_gate","unsmoothed_drive_ratio","one_bar_stale_crossover","direction_flip")
