...
from training import evaluate_high_volatility_serial_autocorrelation_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVSAR-12"
    ...
    assert economics.CONTROLS == ("no_variation_gate", "no_autocorrelation_tail_gate", "one_boundary_stale_features", "fixed_momentum", "fixed_reversal", "direction_flip")
