...
from training import evaluate_asian_carry_unwind_concordance_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "ACUCR-12"
    ...
    assert economics.CONTROLS == ("no_volatility_gate", "aud_leg_only", "jpy_leg_only", "one_session_stale_concordance", "direction_flip", "forced_long")
