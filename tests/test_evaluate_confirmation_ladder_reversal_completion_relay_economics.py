...
from training import evaluate_confirmation_ladder_reversal_completion_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "CLRCR-6"
    ...
    assert economics.CONTROLS == ("late_unanimity_only", "completion_dominance_only", "one_anchor_stale_ladder", "direction_flip")
