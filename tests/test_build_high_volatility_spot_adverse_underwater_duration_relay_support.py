...
from training import build_high_volatility_spot_adverse_underwater_duration_relay_support as support
...
def test_contract_is_frozen():
    assert support.PREREG_SHA == "6f65fe4632da0c714cf971a95d1be98fb28bb8ef2a4926188656ff58af676446"
    assert "FROM bars_binance_spot" in support.QUERY
