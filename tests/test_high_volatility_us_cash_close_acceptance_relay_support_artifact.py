...
def test_source_support_rejection_is_terminal_and_hash_bound() -> None:
    payload = json.loads(RESULT.read_text()); core = {k: v for k, v in payload.items() if k != "manifest_hash"}
