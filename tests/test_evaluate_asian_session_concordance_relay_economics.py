...
from training import evaluate_asian_session_concordance_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "ASCR-16"
    ...
    assert economics.CONTROLS == ("full_session_return", "first_half_only", "second_half_only", "direction_flip")
