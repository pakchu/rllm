...
from training import evaluate_lagged_flow_impact_coherence_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "LFIC-12"
    ...
    assert economics.CONTROLS == ("contemporaneous_coherence", "no_flow_magnitude_tail", "stale_recent_flow", "direction_flip")
