...
import pandas as pd
from training import evaluate_cboe_convexity_acceleration_dual_confirmation_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
 assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest()=="a8d9c8b42f5f9daaee496343e6eb14ad1276344a9fd0a640b335741c2def6fcf"
