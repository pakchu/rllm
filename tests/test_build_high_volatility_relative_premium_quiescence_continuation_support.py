...
from training import build_high_volatility_relative_premium_quiescence_continuation_support as support
...
def test_primary_and_controls_use_frozen_gates() -> None:
    frame = pd.DataFrame({
        ...
        "relative_premium_activity": [1.0, 1.0, 1.0], "relative_premium_activity_rank": [0.2, 0.2, 0.3],
    ...
    assert support.conditions(frame, "no_premium_activity_gate")[0].tolist() == [True, False, True]
...
def test_builder_queries_are_source_only() -> None:
    ...
    assert support.PREREG_SHA == "3a2ab8228b765f4b1e85fcd7c7b75a0929eae73bcc86794a4468d66018f488b9"
