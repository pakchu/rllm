...
from training import build_high_volatility_amihud_liquidity_premium_relay_support as support
    ...
    return pd.DataFrame(
        {
            ...
            "raw_illiquidity_rank": [0.9, 0.1, 0.6, 0.4, 0.1, 0.9],
...
def test_primary_and_controls_are_outcome_blind():
    ...
    raw_activity, raw_side, _ = support.active(panel(), "raw_illiquidity_rank")
