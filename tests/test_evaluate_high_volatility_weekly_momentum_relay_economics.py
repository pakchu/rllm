...
from training import evaluate_high_volatility_weekly_momentum_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVWMR-72"
    ...
    assert economics.CONTROLS == ("no_volatility_gate", "one_week_stale_features", "direction_flip", "forced_long")
