...
def test_bound_and_empty_safe():
 assert e.POLICY_ID=="HVCARER-12" and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==("no_btc_variation_gate","three_of_six_breadth","median_alt_range_level","one_day_stale_breadth","direction_flip","forced_long")
