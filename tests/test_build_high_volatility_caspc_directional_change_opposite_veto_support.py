import pandas as pd
from training import build_high_volatility_caspc_directional_change_opposite_veto_support as s
def base_row(t):
...
def test_contract():assert s.PREREG_SHA=='91fdec4432ce9572d088f2173e2d97a9049bf750ab22f539a6af62514ce64826'
