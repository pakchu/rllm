...
def test_dlsdr_novelty_evaluator_is_outcome_blind_and_frozen():
 source=Path(n.__file__).read_text();assert n.POLICY=='DLSDR-6' and n.LIMITS['exact_entry_jaccard']==.1
