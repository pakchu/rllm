...
from training import evaluate_high_volatility_failed_auction_escape_reversal_relay_economics as e


def test_evaluator_is_bound_and_empty_safe():
    assert e.POLICY_ID == "HVFAER-8"
