...
from training import evaluate_weekend_monday_liquidity_handoff_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "WMLHR-16"
    ...
    assert economics.CONTROLS == ("no_liquidity_reentry", "weekend_continuation", "monday_fade", "direction_flip")
