...
import pandas as pd
from training import evaluate_cboe_surface_dislocation_overnight_btc_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
 assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest()=="e3f911f8f1fe702a5a25b0f5df5eea47de94c8e5cf98cf636e3dc5f731576ea0"
