import hashlib,json
from training import evaluate_high_volatility_directional_excursion_area_dominance_relay_economics as economics
def test_hvdeadr_train_rejection_is_terminal_and_later_stages_are_sealed():
 p=economics.OUTPUTS["train"];assert hashlib.sha256(p.read_bytes()).hexdigest()=="0b7a897bef32ebafe1aee63fc3444ac730cbb6336faccdc902ed3f817de6e831"
 ...
 assert x["primary"]["base"]["absolute_return_pct"]>0 and x["primary"]["stress"]["absolute_return_pct"]<0
