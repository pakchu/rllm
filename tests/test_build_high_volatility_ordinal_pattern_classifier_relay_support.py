...
from training import build_high_volatility_ordinal_pattern_classifier_relay_support as support
...
def test_controls_are_diagnostic_only():
    ...
    assert support.conditions(candidate, model(), "no_score_gate")[0].tolist() == [True, True, True, False, True]
