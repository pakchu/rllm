...
from training import evaluate_high_volatility_interbar_gap_dominance_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVIGDR-6"
    ...
    assert economics.CONTROLS == ("no_gap_dominance_gate", "no_block_return_tail", "no_volatility_gate", "latest_dominant_gap_tie_break", "direction_flip")
