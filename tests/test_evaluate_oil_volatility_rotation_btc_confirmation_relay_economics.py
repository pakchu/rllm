...
from training import evaluate_oil_volatility_rotation_btc_confirmation_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
    assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest() == "6fccbbd0d3fe9843e0c9ddf73d9462053591f98d27e965dc74bf9e53b0bdc720"
