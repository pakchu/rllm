...
from training import evaluate_high_volatility_realized_skew_reversal_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVRSR-12"
    ...
    assert economics.CONTROLS == ("no_volatility_gate", "no_skew_tail", "raw_third_moment", "one_day_stale_features", "direction_flip", "forced_long")
