...
import numpy as np
import pandas as pd
from training import build_high_volatility_causal_extreme_displacement_reversal_support as s
...
def test_panel_requires_contiguous_auctions_and_causal_ranks(monkeypatch) -> None:
    ...
    bars["source_rows"]=240;bars["distinct_rows"]=240;bars["first_ts"]=times-pd.Timedelta("4h")
