import numpy as np
import pandas as pd
from training import build_high_volatility_won_risk_session_relay_support as s
def frame():return pd.DataFrame({'signal_valid':[True]*4,'won_risk_direction':[1,-1,1,-1],'shock_rank':[.8,.9,.7,.8],'btc_realized_variation_rank':[.7,.8,.9,.4]})
def test_primary_follows_canonical_won_risk():
...
def test_pinned_registration():assert s.PREREG_SHA=='a67c8bf113952abe3ad032f16142f3325dea2498615a8935dd4ef5aab6f50c64'
