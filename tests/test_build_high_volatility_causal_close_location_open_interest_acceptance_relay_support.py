...
import numpy as np
import pandas as pd
from training import build_high_volatility_causal_close_location_open_interest_acceptance_relay_support as s
...
def test_panel_requires_oi_expansion_outer_close_and_causal_variation(monkeypatch) -> None:
    ...
    oi = pd.DataFrame({"decision_time": times, "sum_open_interest": [100., 110., 105., 120., 130.]})
