...
FREEZE = Path(
    "results/high_volatility_quartile_median_staircase_relay_economic_evaluator_freeze_2026-08-10.json"
)
...
def test_hvqmsr_economic_freeze_is_outcome_blind_and_code_bound():
