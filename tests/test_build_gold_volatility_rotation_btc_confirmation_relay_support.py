...
def rows():
 return pd.DataFrame({'valid':[True,True,True],'delta_log_relative':[.1,.1,-.1],'absolute_rotation_rank':[.7,.7,.7],'delta_log_gvz':[.1,.1,-.1],'absolute_gvz_rank':[.7]*3,'delta_log_vix':[.05,.05,-.05],'absolute_vix_rank':[.7]*3,'overnight_btc_return':[-.01,.01,.01]})
