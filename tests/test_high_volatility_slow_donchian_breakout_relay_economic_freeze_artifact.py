...
FREEZE = Path(
    "results/high_volatility_slow_donchian_breakout_relay_economic_evaluator_freeze_2026-08-10.json"
)
...
def test_hvsdbr_economic_freeze_is_outcome_blind_and_code_bound():
