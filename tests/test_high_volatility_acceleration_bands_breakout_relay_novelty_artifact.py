...
R=Path("results/high_volatility_acceleration_bands_breakout_relay_gross9_novelty_2026-08-11.json")
def test_novelty_pass_is_blind_and_frozen():
 ...
 assert hashlib.sha256(R.read_bytes()).hexdigest()=="3cd17616cd2ed74c907f3e845212f25ef39729652c27428ddee3f59546c9aade"
