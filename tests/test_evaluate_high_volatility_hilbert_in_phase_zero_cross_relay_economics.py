...
def test_bound_and_empty_safe():
 assert e.POLICY_ID=="HVHILBERT-I7-24" and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==("no_variation_gate","quadrature_zero_cross","in_phase_quadrature_cross","one_bar_stale_cross","direction_flip","forced_long")
