...
from training import evaluate_high_volatility_cross_alt_cojump_propagation_relay_gross9_novelty as novelty


def test_hvcacjp_novelty_evaluator_is_outcome_blind_and_frozen():
    source = Path(novelty.__file__).read_text()
    assert novelty.POLICY == "HVCACJP-6"
...
def test_hvcacjp_novelty_binds_predecessors():
