...
from training import evaluate_high_volatility_volume_return_covariance_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "HVVRCR-12"
    ...
    assert economics.CONTROLS == ("no_volatility_gate", "no_correlation_tail", "unweighted_return", "one_day_stale_features", "direction_flip", "forced_long")
