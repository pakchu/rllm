from training import evaluate_options_risk_peak_leverage_handoff_continuation_economics as economics
import pandas as pd
...
def test_frozen_accounting_and_stage_order_are_exact():
    ...
    assert economics.CONTROLS==("no_prior_dvol_shock","no_current_dvol_cooling","no_dvol_level","no_premium_tail","no_oi_increase","one_hour_stale_features","direction_flip","forced_long")
