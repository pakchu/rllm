...
from training import evaluate_high_volatility_execution_seasonality_surprise_relay_gross9_novelty as n
def c(t,s):
...
def test_metrics_and_binding():
 ...
 assert n.POLICY=='HVESSR-8' and n.sha(n.PREREG)==n.PREREG_SHA and n.sha(n.SUPPORT)==n.SUPPORT_SHA and n.sha(n.CLOCK)==n.CLOCK_SHA
