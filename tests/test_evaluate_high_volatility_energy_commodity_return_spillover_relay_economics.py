...
def test_bound_and_empty_safe():
 assert e.POLICY_ID=="HVECSP-24" and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==("no_btc_volatility_gate","inverse_oil_only","natural_gas_only","one_session_stale_score","direction_flip")
