...
RESULT = Path(
    "results/high_volatility_slow_donchian_breakout_relay_gross9_novelty_2026-08-10.json"
)
...
def test_hvsdbr_novelty_pass_is_frozen_blind():
    ...
    assert sha256(RESULT) == "05be91c9afd23cffb0368f23317f97312654180f1abb49da02820b67273b06d5"
