...
from training import evaluate_cross_market_multi_horizon_trend_concordance_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "CMMTCR-24"
    ...
    assert economics.CONTROLS == ("no_volatility_gate", "btc_horizons_only", "btc_6h_eth_6h_only", "one_day_stale_geometry", "direction_flip", "forced_long")
