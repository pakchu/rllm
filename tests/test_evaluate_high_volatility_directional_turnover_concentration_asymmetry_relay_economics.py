...
from training import evaluate_high_volatility_directional_turnover_concentration_asymmetry_relay_economics as e


def test_evaluator_is_bound_and_empty_safe():
    assert e.POLICY_ID == "HVDTCAR-8"
