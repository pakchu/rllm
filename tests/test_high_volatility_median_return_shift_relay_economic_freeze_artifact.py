...
FREEZE = Path(
    "results/high_volatility_median_return_shift_relay_economic_evaluator_freeze_2026-08-10.json"
)
...
def test_hvmrsr_economic_freeze_is_outcome_blind_and_code_bound():
