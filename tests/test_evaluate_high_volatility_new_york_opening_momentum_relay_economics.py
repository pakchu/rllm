...
import pandas as pd
from training import evaluate_high_volatility_new_york_opening_momentum_relay_economics as e
def test_bound_and_empty_safe():
 assert e.POLICY_ID=="HVCOM-355M" and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==("no_variation_gate","first_fifteen_minute_direction","one_weekday_stale_reaction","direction_flip","forced_long")
