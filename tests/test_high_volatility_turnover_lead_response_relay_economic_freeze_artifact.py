...
FREEZE = Path(
    "results/high_volatility_turnover_lead_response_relay_economic_evaluator_freeze_2026-08-10.json"
)
...
def test_hvtlrr_economic_freeze_is_outcome_blind_and_code_bound():
