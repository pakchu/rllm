...
from training import evaluate_cross_venue_relative_volatility_premium_regime_crossing_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
    assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest() == "0c86cca5af9199e1778cce75ae94b2795a32de97642e2f98ea48a41a0c08bf7d"
