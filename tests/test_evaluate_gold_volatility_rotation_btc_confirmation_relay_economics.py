...
from training import evaluate_gold_volatility_rotation_btc_confirmation_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
    assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest() == "aeafc3a2e465e819823bd910345c974640e4c4876db642be0082050c49dbd674"
