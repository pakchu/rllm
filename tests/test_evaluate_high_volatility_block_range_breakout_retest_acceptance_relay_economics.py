...
from training import evaluate_high_volatility_block_range_breakout_retest_acceptance_relay_economics as e


def test_evaluator_is_bound_and_empty_safe():
    assert e.POLICY_ID == "HVRBRAR-8"
    ...
    assert e.CONTROLS == (
        "no_retest_requirement",
        "no_variation_gate",
        "terminal_breakout_close",
