...
def test_parse_selects_only_tga_closing_balance():
    raw = json.dumps({"data": [
        {"record_date": "2020-01-02", "account_type": builder.ACCOUNT_TYPE, "open_today_bal": "400000"},
        {"record_date": "2020-01-02", "account_type": "Total TGA Deposits (Table II)", "open_today_bal": "10"},
