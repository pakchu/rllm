...
from training import evaluate_confirmation_ladder_transaction_density_relay_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "CLTDR-6"
    ...
    assert economics.CONTROLS == ("late_unanimity_only", "transaction_density_only", "one_anchor_stale_ladder", "direction_flip")
