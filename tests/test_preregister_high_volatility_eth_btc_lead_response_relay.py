from training import preregister_high_volatility_eth_btc_lead_response_relay as p


def test_hveblr_boundary_and_policy():
    result = p.build()
    assert result["policy_id"] == "HVEBLR-8"
