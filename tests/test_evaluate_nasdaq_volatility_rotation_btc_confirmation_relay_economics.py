...
from training import evaluate_nasdaq_volatility_rotation_btc_confirmation_relay_economics as economics
...
def test_outcome_blind_evaluator_freeze_is_bound():
    assert hashlib.sha256(economics.FREEZE.read_bytes()).hexdigest() == "b6d2acbf079956730dc61ca94c163e9d2b8be5f9db9ba449c7d5f70649d74119"
