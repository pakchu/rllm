...
from training import build_high_volatility_energy_technology_spillover_relay_support as b
...
def test_clock_uses_actual_early_close_and_frozen_delays():
    frame = pd.DataFrame(
        {
            ...
            "xle_intraday_return": [0.02], "xlk_intraday_return": [0.01], "factor": [0.015],
            "factor_z": [1.5], "xle_z": [1.5], "xlk_z": [1.5],
    ...
    assert clock.exit_time.iloc[0] == pd.Timestamp("2023-07-04T05:10:00Z")
