...
def test_dopdr_support_artifact_is_terminal_before_outcomes():
    result = json.load(open("results/daily_oi_price_dislocation_reconciliation_relay_support_2026-08-08.json"))
