...
from training import evaluate_ticket_expansion_concordance_continuation_economics as economics
...
def test_frozen_accounting_and_stage_contract():
    assert economics.POLICY_ID == "TECC-12"
    ...
    assert economics.CONTROLS == ("no_ticket_tail", "no_concordance", "early_ticket_dominance", "direction_flip")
