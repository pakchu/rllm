...
def test_bound_empty_and_strict():
 assert e.POLICY_ID=='HVECE-8' and e.sha256(e.PREREG)==e.PREREG_SHA and e.sha256(e.SUPPORT)==e.SUPPORT_SHA and e.sha256(e.NOVELTY)==e.NOVELTY_SHA and e.sha256(e.CLOCK)==e.CLOCK_SHA
 assert e.CONTROLS==('no_elasticity_tail','no_variation_gate','raw_return_tail','one_block_stale_geometry','direction_flip','forced_long')
