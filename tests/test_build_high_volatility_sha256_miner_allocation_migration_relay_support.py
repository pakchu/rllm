...
from training import build_high_volatility_sha256_miner_allocation_migration_relay_support as support
...
def test_reservation_keeps_equal_exit_entry_and_uses_migration_side() -> None:
    ...
    panel = pd.DataFrame({
        ...
        "btc_hashrate": 100.0,
        "bch_hashrate": 1.0,
        "btc_block_count": 144.0,
        "bch_block_count": 144.0,
        "relative_hash_allocation": 1.0,
        "allocation_migration": [1.0, 0.0, -1.0, 0.0, 1.0, 0.0],
        "btc_hashrate_change": [1.0, 0.0, -1.0, 0.0, 1.0, 0.0],
        "source_valid": True,
