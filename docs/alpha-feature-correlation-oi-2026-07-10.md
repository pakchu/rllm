...
- `continuous_pearson_csv`: `results/alpha_feature_correlation_oi_2026-07-10/continuous_pearson.csv`
- `continuous_spearman_csv`: `results/alpha_feature_correlation_oi_2026-07-10/continuous_spearman.csv`
- `component_phi_csv`: `results/alpha_feature_correlation_oi_2026-07-10/component_phi.csv`
- `component_jaccard_csv`: `results/alpha_feature_correlation_oi_2026-07-10/component_jaccard.csv`
- `continuous_spearman_heatmap_png`: `results/alpha_feature_correlation_oi_2026-07-10/continuous_spearman_heatmap.png`
- `component_phi_heatmap_png`: `results/alpha_feature_correlation_oi_2026-07-10/component_phi_heatmap.png`
...
|---:|---|---|---:|
| 1 | `funding_z` | `funding_zscore` | 1.0000 |
| 2 | `htf_1w_drawdown_4` | `weekly_drawdown_4w` | 1.0000 |
| 3 | `htf_1w_range_1` | `weekly_range_1w` | 1.0000 |
| 4 | `htf_1w_range_pos` | `weekly_range_pos` | 1.0000 |
| 5 | `htf_1w_return_1` | `weekly_return_1w` | 1.0000 |
| 6 | `htf_1w_return_4` | `weekly_return_4w` | 1.0000 |
| 7 | `oi_minus_px_z_72` | `px_minus_oi_z_72` | -1.0000 |
| 8 | `premium_index_zscore` | `premium_z` | 1.0000 |
| 9 | `rex_8640_cur_to_max_pct` | `rex_8640_max_to_cur_pct` | -1.0000 |
| 10 | `rex_144_cur_to_max_pct` | `rex_144_max_to_cur_pct` | -1.0000 |
| 11 | `rex_576_cur_to_max_pct` | `rex_576_max_to_cur_pct` | -1.0000 |
| 12 | `rex_2016_cur_to_max_pct` | `rex_2016_max_to_cur_pct` | -1.0000 |
| 13 | `rex_36_cur_to_max_pct` | `rex_36_max_to_cur_pct` | -1.0000 |
| 14 | `close_zscore_48` | `rex_36_range_pos` | 0.9156 |
| 15 | `rex_8640_cur_to_max_pct` | `rex_8640_range_pos` | 0.9051 |
| 16 | `rex_8640_max_to_cur_pct` | `rex_8640_range_pos` | -0.9051 |
| 17 | `px_ret_z_24` | `trend_24` | 0.8918 |
| 18 | `rex_2016_max_to_cur_pct` | `rex_2016_range_pos` | -0.8715 |
| 19 | `rex_2016_cur_to_max_pct` | `rex_2016_range_pos` | 0.8715 |
| 20 | `px_ret_z_144` | `trend_96` | 0.8486 |
...
- `btc_ohlcv_taker_core`: `vwap_gap_z`, `rvol_z_24`, `rvol_z_72`, `qv_z_24`, `qv_z_72`, `spread_z_72`, `pos_288`, `range_compress_288`, `range_expand_72`, `taker_mean_z_24`, `taker_mean_z_72`, `taker_div_72`, `taker_div_144`, `cvd_ret_z_72`, `cvd_ret_z_144`, `us_session`, `asia_session`
- `btc_oi_features`: `oi_squeeze_long_ctx`, `oi_squeeze_short_ctx`, `oi_unwind_long_ctx`, `oi_unwind_short_ctx`
- `btc_funding_premium_basis`: `basis_stress_z`
...
- OI-derived features are present in this run; remaining OI-context missing items are higher-level aliases/composites not generated by this report script.
