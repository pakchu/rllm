"""Evaluate frozen HVCAOFTAR-8 structural novelty against every Gross9 sleeve."""
...
POLICY = "HVCAOFTAR-8"
PROTOCOL = "hvcaoftar_8_gross9_novelty_v1"
PREREG = Path("results/high_volatility_cross_alt_order_flow_tail_asymmetry_relay_preregistration_2026-08-11.json")
PREREG_SHA = "064afaa56797a769ec17ac203ebc893064548fbce7edafe26de391c0d28b2bb9"
SUPPORT = Path("results/high_volatility_cross_alt_order_flow_tail_asymmetry_relay_support_2026-08-11.json")
SUPPORT_SHA = "21a51a673453c40f7d55ec178a3a619012d5586ddbb8fa709e723299be322bd9"
CLOCK = Path("data/high_volatility_cross_alt_order_flow_tail_asymmetry_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "4d0a2cdca1d2d26b23b63ab1d576f260c67985dd666faf7439c9b0afe545ef6a"
OUTPUT = Path("results/high_volatility_cross_alt_order_flow_tail_asymmetry_relay_gross9_novelty_2026-08-11.json")
LIMITS = {
...
def run(output: Path = OUTPUT) -> dict:
    if sha(PREREG) != PREREG_SHA or sha(SUPPORT) != SUPPORT_SHA or sha(CLOCK) != CLOCK_SHA:
        raise RuntimeError("HVCAOFTAR predecessor hash drift")
    ...
    if preregistration.get("novelty_gates") != expected_limits:
        raise RuntimeError("HVCAOFTAR novelty limits drift")
    if (
        ...
        raise RuntimeError("HVCAOFTAR predecessor state drift")
    ...
    candidate = metric.load_clock(CLOCK, label="HVCAOFTAR primary")
    sleeve_results = {}
    ...
    core = {
        ...
        "evidence_boundary": {
            "hvcaoftar_clock_rows_opened": len(candidate),
        ...
        "failure_action": None if advance else "reject HVCAOFTAR-8 unchanged before economic outcomes",
    }
