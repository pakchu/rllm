"""Sequential strict economics for frozen HVDCSATPA-8."""
...
PREREG = Path("results/high_volatility_directional_change_scarcity_ticket_participation_acceleration_relay_preregistration_2026-08-16.json")
PREREG_SHA = "8003732efa6d369c474ec08b71178729a4ba557f43ec7325142bec01a203f153"
SUPPORT = Path("results/high_volatility_directional_change_scarcity_ticket_participation_acceleration_relay_support_2026-08-16.json")
SUPPORT_SHA = "5abaebfb9999921fd9834ade8a928c55326d0a0ca3cb09bb22d920c491bbefe6"
NOVELTY = Path("results/high_volatility_directional_change_scarcity_ticket_participation_acceleration_relay_gross9_novelty_2026-08-16.json")
NOVELTY_SHA = "28bed590847c8c3582424875b9a54a8d02bba54cb65f5bd5ecf6c3132c71dd44"
...
CLOCK_SHA = "089a077cfe89b63540a4b0b0af1a18bf9b5818ac269875e2e9e688c2c432cef0"
...
FREEZE = Path("results/high_volatility_directional_change_scarcity_ticket_participation_acceleration_relay_economic_evaluator_freeze_2026-08-16.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_directional_change_scarcity_ticket_participation_acceleration_relay_{stage}_economics_2026-08-16.json")
    for stage in STAGES
}
CONTROLS = ("no_joint_ticket_participation_acceleration_gate", "no_directional_change_scarcity_tail", "no_variation_gate", "raw_directional_changes_at_most_478", "one_block_stale_geometry", "direction_flip", "forced_long")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVDCSATPA frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVDCSATPA novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvdcsatpa_8_sequential_economics_v1", "policy_id": POLICY_ID,
