"""Evaluate frozen HVPASR-12 structural novelty against every Gross9 sleeve."""
...
POLICY = "HVPASR-12"
PROTOCOL = "hvpasr_12_gross9_novelty_v1"
PREREG = Path(
...
OUTPUT = Path(
    "results/high_volatility_premium_activity_sponsorship_relay_gross9_novelty_2026-08-09.json"
)
LIMITS = {
...
def run(output: Path = OUTPUT) -> dict[str, Any]:
    ...
    core = {
        ...
        "evidence_boundary": {
            "hvpasr_clock_rows_opened": len(candidate),
        ...
        "failure_action": (
            None if advance else "reject HVPASR-12 unchanged before economic outcomes"
        ),
    }
