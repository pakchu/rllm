"""Materialize source-only DFSR-12 support clocks."""
...
PREREG_SHA="e7a2309c478d0454d61a97c2fd49660b93757923ae2af9c625538dfa5a080b54"
SOURCE_DIR=Path("data/dollar_factor_shock_relay_sources_2023_2026"); SESSION=SOURCE_DIR/"dollar_factor_sessions.csv.gz"; SOURCE_MANIFEST=SOURCE_DIR/"manifest.json"
...
CLOCK=Path("data/dollar_factor_shock_relay_clocks_2023_2026.csv.gz"); CONTROL_DIR=Path("data/dollar_factor_shock_relay_controls_2023_2026"); RESULT=Path("results/dollar_factor_shock_relay_support_2026-08-09.json")
...
def run()->dict:
 if sha(prereg.DEFAULT_OUTPUT)!=PREREG_SHA:raise RuntimeError("DFSR preregistration hash drift")
