...
PREREG = Path("results/high_volatility_relative_vigor_crossover_relay_preregistration_2026-08-11.json")
PREREG_SHA = "30e0243792b91ecbf47c40acb6b198c647bf9b4b98d5672f134c150a26dee71e"
SUPPORT = Path("results/high_volatility_relative_vigor_crossover_relay_support_2026-08-11.json")
SUPPORT_SHA = "cc6ec9d393acbd1eaec12e6585d3e004ccc9f1c0f7016dd489bfce9ec75b8f4e"
NOVELTY = Path("results/high_volatility_relative_vigor_crossover_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "a38f6c02e2b32bce2f208adccef456c69a687f63294e7c775fc8eb7b16bf5ed1"
CLOCK = Path("data/high_volatility_relative_vigor_crossover_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "7fbe8f0915d89842335cc9a7fede4ceb8bd355bdc3f63d263158e7c8ca1c4a7a"
CONTROL_DIR = Path("data/high_volatility_relative_vigor_crossover_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_relative_vigor_crossover_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_relative_vigor_crossover_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
CONTROLS = ("no_variation_gate", "unsmoothed_drive_ratio", "one_bar_stale_crossover", "direction_flip")
