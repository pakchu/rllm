"""Sequential strict economics for frozen HVWTO-C10-21-4-24."""
...
PREREG = Path("results/high_volatility_wave_trend_oscillator_crossover_relay_preregistration_2026-08-11.json")
PREREG_SHA = "03f9d8596f39f97d0779cfbc5ba8aa2e17f7f38e5d81a713e8b5427bcfd5dc61"
SUPPORT = Path("results/high_volatility_wave_trend_oscillator_crossover_relay_support_2026-08-11.json")
SUPPORT_SHA = "cbd9e157749a1d2714c0fbcf46e24cc2b0c8a5c7505428216b3fc2cbfefc9ebc"
NOVELTY = Path("results/high_volatility_wave_trend_oscillator_crossover_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "1613d3bdb8c6ea9db851e79788873adbf0ce9cb0467bb4af2cf73255f29eecfd"
CLOCK = Path("data/high_volatility_wave_trend_oscillator_crossover_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "b06ef6f4d6f65b7bcbbe9cd08ea997966f928f2eb0c41637f0abe4b222c9ea8b"
CONTROL_DIR = Path("data/high_volatility_wave_trend_oscillator_crossover_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_wave_trend_oscillator_crossover_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_wave_trend_oscillator_crossover_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVWTO frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVWTO novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvwto_c10_21_4_24_sequential_economics_v1", "policy_id": POLICY_ID,
