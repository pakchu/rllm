"""Sequential strict economics for frozen HVPSAR-24."""
...
PREREG = Path("results/high_volatility_parabolic_sar_reversal_relay_preregistration_2026-08-11.json")
PREREG_SHA = "5ce0a2137c1afbd11d5739b1595aa0ccaa79adc45ec01e6ff45637de02f38cc8"
SUPPORT = Path("results/high_volatility_parabolic_sar_reversal_relay_support_2026-08-11.json")
SUPPORT_SHA = "1d120deba47e226d110f9225e02e3bd41734fe8c6f3ae18cabee19f4299d48a6"
NOVELTY = Path("results/high_volatility_parabolic_sar_reversal_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "983bd3743429b2e473c70e280ad3c8c745aa0a655808e744d20c6f13320668b8"
CLOCK = Path("data/high_volatility_parabolic_sar_reversal_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "8c3de83475ac841fdd46648dc7d29e04c0620df2a881986586bc823723a1ef79"
CONTROL_DIR = Path("data/high_volatility_parabolic_sar_reversal_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_parabolic_sar_reversal_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_parabolic_sar_reversal_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
CONTROLS = ("no_variation_gate", "no_two_bar_clamp", "one_bar_stale_reversal", "direction_flip")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVPSAR frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVPSAR novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvpsar_24_sequential_economics_v1", "policy_id": POLICY_ID,
