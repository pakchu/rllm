...
def build() -> dict[str, Any]:
    ...
    contract.update(
        ...
        features={
            ...
            "volatility_4": "on 24 bars, lower=mean-2*population_std, middle=mean, upper=mean+2*population_std; (close-lower)/close, (close-middle)/close, (close-upper)/close, and (upper-lower)/middle",
