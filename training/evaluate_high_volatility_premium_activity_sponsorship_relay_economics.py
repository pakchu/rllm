"""Sequential strict economics for frozen HVPASR-12."""
...
PREREG = Path("results/high_volatility_premium_activity_sponsorship_relay_preregistration_2026-08-09.json")
PREREG_SHA = "d428a7065e47203e0daf9f99d2862280e9d147569fa5b737703338506802824d"
SUPPORT = Path("results/high_volatility_premium_activity_sponsorship_relay_support_2026-08-09.json")
SUPPORT_SHA = "b29d5562edc70149f2a7bd5992acfc8c64d4a8761724bd14430fc3a54296181c"
NOVELTY = Path("results/high_volatility_premium_activity_sponsorship_relay_gross9_novelty_2026-08-09.json")
NOVELTY_SHA = "209225b36565239501e99f0cc7bb573b3f939ac6ba8650006320eba5bd063848"
CLOCK = Path("data/high_volatility_premium_activity_sponsorship_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "83b2f8d9bc6423b4b73ab799f5e1112d0f983ef824c8d242c06d69d090d27e27"
CONTROL_DIR = Path("data/high_volatility_premium_activity_sponsorship_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_premium_activity_sponsorship_relay_economic_evaluator_freeze_2026-08-09.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_premium_activity_sponsorship_relay_{stage}_economics_2026-08-09.json")
    for stage in STAGES
}
CONTROLS = ("no_premium_activity_gate", "no_btc_variation_gate", "one_day_stale_features", "direction_flip", "same_clock_forced_long")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvpasr_12_sequential_economics_v1", "policy_id": POLICY_ID,
