"""Sequential strict economics for frozen HVPAR-8."""
...
PREREG = Path("results/high_volatility_path_analog_relay_preregistration_2026-08-10.json")
PREREG_SHA = "73d207071f55dcd1995ca41489bd2113a160c0b348e17e32477cbcf15f080d37"
SUPPORT = Path("results/high_volatility_path_analog_relay_support_2026-08-10.json")
SUPPORT_SHA = "e65f4e8e0d4f62a550482e18fe5d9ff83ac9832db8cd1b7bc9c866668afc0673"
NOVELTY = Path("results/high_volatility_path_analog_relay_gross9_novelty_2026-08-10.json")
NOVELTY_SHA = "d20c9a74d9d2ec21b3b5141844f5a033af8acb3ff09ed0c867afe881d26add00"
CLOCK = Path("data/high_volatility_path_analog_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "3406a125293f75b7db4efcda9d7ac72ef52bade4ebf2c687e37f5f7b174ad13a"
CONTROL_DIR = Path("data/high_volatility_path_analog_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_path_analog_relay_economic_evaluator_freeze_2026-08-10.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_path_analog_relay_{stage}_economics_2026-08-10.json")
    for stage in STAGES
}
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVPAR novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvpar_8_sequential_economics_v1", "policy_id": POLICY_ID,
