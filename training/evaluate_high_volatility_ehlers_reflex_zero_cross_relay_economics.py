...
PREREG = Path("results/high_volatility_ehlers_reflex_zero_cross_relay_preregistration_2026-08-11.json")
PREREG_SHA = "60dc33c79028cd44f78e001c60a9747c181359efe885e4d7cf747e92e3e65380"
SUPPORT = Path("results/high_volatility_ehlers_reflex_zero_cross_relay_support_2026-08-11.json")
SUPPORT_SHA = "09b165debf457efe9125c6af0b2b9009c8114ceefbea0d72c1b752facbb95f03"
NOVELTY = Path("results/high_volatility_ehlers_reflex_zero_cross_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "b171422cd81477c4c3d4e1b4f1ecfe0baf6ae17a858f45d2ef11436b69078317"
CLOCK = Path("data/high_volatility_ehlers_reflex_zero_cross_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "ec4a2a572b6cdf83be85d5c15d9f0806d769c71518cd236dc9c81339f06ea11f"
CONTROL_DIR = Path("data/high_volatility_ehlers_reflex_zero_cross_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_ehlers_reflex_zero_cross_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_ehlers_reflex_zero_cross_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
CONTROLS = ("no_variation_gate", "filtered_slope_zero_cross", "one_bar_stale_cross", "direction_flip")
