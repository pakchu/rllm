"""Sequential strict economics for frozen HVPMO-24."""
...
PREREG = Path("results/high_volatility_price_momentum_oscillator_crossover_relay_preregistration_2026-08-11.json")
PREREG_SHA = "ca64fa1b68f71bcdeda1b196c47392c132896b00d1c1ef823efeea32e4331721"
SUPPORT = Path("results/high_volatility_price_momentum_oscillator_crossover_relay_support_2026-08-11.json")
SUPPORT_SHA = "83457aa336bf02c3455c127731e66ed1b67d6443d141ed212a5eb85babcf0f4b"
NOVELTY = Path("results/high_volatility_price_momentum_oscillator_crossover_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "3b5efcf2959e58433240ea4c18314953b61037dfd4de4775a98991d2cf3c4065"
CLOCK = Path("data/high_volatility_price_momentum_oscillator_crossover_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "9c2cc18813b61a0758212c0d98a514f74da8b573b2d1ccdcc1f25c33c7273911"
CONTROL_DIR = Path("data/high_volatility_price_momentum_oscillator_crossover_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_price_momentum_oscillator_crossover_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_price_momentum_oscillator_crossover_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVPMO frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVPMO novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvpmo_24_sequential_economics_v1", "policy_id": POLICY_ID,
