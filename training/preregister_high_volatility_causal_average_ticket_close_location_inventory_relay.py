"""Outcome-blind preregistration for HVCATCLIR-8."""
...
DEFAULT_OUTPUT = Path("results/high_volatility_causal_average_ticket_close_location_inventory_relay_preregistration_2026-08-16.json")
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_causal_average_ticket_close_location_inventory_relay_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            "claim": "When BTC perpetual average quote ticket size accelerates unusually from the first to the second four-hour half, the completed cycle closes in the directional outer 35 percent of its exact high-low range, realized variation is elevated, and open interest expands, large transactions, directional price acceptance, and fresh leveraged inventory sponsor the completed direction for eight hours.",
            "side": "strict sign of the completed eight-hour BTC perpetual return",
            "why_distinct": "HVCATCLIR requires within-cycle acceleration in quote turnover per transaction and independently confirms the completed direction with an exact completed-range close location, plus exact OI expansion and variation. No prior composite event set or control is reused; it uses no spot, ETH, funding, premium-index, fitted outcome, or promoted control.",
        ...
        "stopping_rule": "terminal first failure; no OI endpoint or expansion rule, average-ticket acceleration formula, close-location confirmation, acceleration or variation history, side, clock, hold, subset, threshold, comparator, or control repair",
    }
