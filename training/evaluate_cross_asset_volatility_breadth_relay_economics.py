"""Sequential strict economics for frozen CAVBR-12."""
...
PREREG = Path("results/cross_asset_volatility_breadth_relay_preregistration_2026-08-09.json")
PREREG_SHA = "7c5764bab97c530467a8b930e2d2e38a083096c98abfcf7d83a6d902b93d1775"
SUPPORT = Path("results/cross_asset_volatility_breadth_relay_support_2026-08-09.json")
SUPPORT_SHA = "2fd2f5afa866bc72287fc8c5deaf8b6511552f1dc49c3a216583ba21a6376005"
NOVELTY = Path("results/cross_asset_volatility_breadth_relay_gross9_novelty_2026-08-09.json")
NOVELTY_SHA = "344f06169e16efe0d5cdfecb7a2ae83c15aa47cbb31e1dd14f0ad91beec1d020"
CLOCK = Path("data/cross_asset_volatility_breadth_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "affa5f02cb4a07bf0aa715f29941bf5cbbadae4f5d48855250c37d1a6f545ec0"
CONTROL_DIR = Path("data/cross_asset_volatility_breadth_relay_controls_2023_2026")
FREEZE = Path("results/cross_asset_volatility_breadth_relay_economic_evaluator_freeze_2026-08-09.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/cross_asset_volatility_breadth_relay_{stage}_economics_2026-08-09.json")
    for stage in STAGES
}
CONTROLS = ("no_volatility_gate", "vix_only", "equity_pair_only", "one_session_stale_breadth", "direction_flip")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("CAVBR frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("CAVBR novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "cavbr_12_sequential_economics_v1", "policy_id": POLICY_ID,
