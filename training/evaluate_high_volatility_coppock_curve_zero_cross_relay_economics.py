"""Sequential strict economics for frozen HVCC-24."""
...
PREREG = Path("results/high_volatility_coppock_curve_zero_cross_relay_preregistration_2026-08-11.json")
PREREG_SHA = "4b67f769a3c2bae4ecdcfdf5937a73c75a2dfe548d7c7b3ab2517936dc8c207c"
SUPPORT = Path("results/high_volatility_coppock_curve_zero_cross_relay_support_2026-08-11.json")
SUPPORT_SHA = "7b7a85d7086440f916b23d8e245b3d6203df3ed9183b34976ba77dba73c72dfc"
NOVELTY = Path("results/high_volatility_coppock_curve_zero_cross_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "0e795ec9897a0b07e70dcc28ab7cc3ff8b16d00543a333d42687b3f34923f0a3"
CLOCK = Path("data/high_volatility_coppock_curve_zero_cross_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "9557b2c666ae4f1a2a958a4218c5f6ed690f440fb8872b5d4f9472ad0e161c22"
CONTROL_DIR = Path("data/high_volatility_coppock_curve_zero_cross_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_coppock_curve_zero_cross_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_coppock_curve_zero_cross_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
CONTROLS = ("no_variation_gate", "raw_roc_sum", "one_bar_stale_cross", "direction_flip")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVCC frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVCC novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvcc_24_sequential_economics_v1", "policy_id": POLICY_ID,
