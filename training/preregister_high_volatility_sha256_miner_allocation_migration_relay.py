"""Outcome-blind preregistration for HVSMAM-24."""
...
DEFAULT_OUTPUT = Path(
    "results/high_volatility_sha256_miner_allocation_migration_relay_preregistration_2026-08-10.json"
)
...
def build() -> dict[str, Any]:
    core = {
        "protocol_version": "high_volatility_sha256_miner_allocation_migration_relay_v1",
        "policy_id": "HVSMAM-24",
        ...
        "mechanism": {
            "claim": (
                "BTC and BCH compete for the same SHA-256 mining hardware. During volatile BTC "
                "trading, a large completed three-day migration of estimated hash-solving rate "
                "toward BTC indicates improving relative security-budget sponsorship and is traded "
                "long; migration toward BCH is traded short."
            ),
            "side": "strict sign of the three-observation change in log(BTC HashRate/BCH HashRate)",
            "why_distinct": (
                "Existing miner candidates use BTC-only hash rate, blocks, fees, issuance, cadence, "
                "or retarget state. The repository has no BCH source and no cross-chain SHA-256 "
                "hardware-allocation feature."
            ),
        ...
        "source_contract": {
            ...
            "official_catalog": (
                ...
                "metrics=HashRate%2CBlkCnt%2CAssetEODCompletionTime"
            ),
            "assets": ["btc", "bch"],
            "metrics": ["HashRate", "BlkCnt", "AssetEODCompletionTime"],
            "frequency": "1d",
            "observation_window": ["2023-01-01", "2026-07-31"],
            "schema": ["asset", "time", "HashRate", "BlkCnt", "AssetEODCompletionTime"],
            "row_validity": (
                "exactly one row per asset and UTC observation day; finite strictly-positive "
                "HashRate and BlkCnt; completion epoch at least observation day plus one elapsed day"
            ),
            "pair_validity": (
        ...
        "feature_contract": {
            "relative_hash_allocation": "log(BTC HashRate/BCH HashRate)",
            "allocation_migration": (
                "current relative_hash_allocation minus the value exactly three paired observation "
                "days earlier; strict nonzero"
            ),
            "absolute_migration_rank": (
                "strict-prior midrank of abs(allocation_migration), current excluded, at most 365 "
            ...
            "eligible_state": (
                ...
                "allocation_migration strict nonzero"
            ),
        ...
        "oos_clock": {
            ...
            "side": "sign(allocation_migration)",
        ...
        "research_boundary": {
            "prior_btc_only_miner_family_outcomes_known": True,
            "prior_bch_or_cross_chain_hash_allocation_outcomes_known": False,
            ...
            "selection_basis": (
                "new cross-chain SHA-256 hardware-allocation mechanism fixed before candidate "
