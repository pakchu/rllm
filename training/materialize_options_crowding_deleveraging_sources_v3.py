"""Materialize the preregistered OCDR-12B non-price source snapshot."""
...
OUTPUT_DIR = Path("data/options_crowding_deleveraging_relay_sources_v3_2023_2026")
...
def run(env_file: str, output_dir: Path = OUTPUT_DIR) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "ocdr_12b_source_snapshot_v1",
