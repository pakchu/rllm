"""Sequential strict economics for frozen CVTBR-6."""
...
PREREG = Path("results/cboe_term_regime_overnight_btc_relay_preregistration_2026-08-08.json")
PREREG_SHA = "a2bfb00484ebd03c73733df74f63f477a2037271d310515184f35f99deb41687"
SUPPORT = Path("results/cboe_term_regime_overnight_btc_relay_support_2026-08-08.json")
SUPPORT_SHA = "ce631b76f078837e7fb1278de876fae5055e3a93d61d33a2e86a4374651a82ce"
NOVELTY = Path("results/cboe_term_regime_overnight_btc_relay_gross9_novelty_2026-08-08.json")
NOVELTY_SHA = "3629930f9439a7c864f6513acfb59efff8142da2b770f8578022f840f04cc6d8"
CLOCK = Path("data/cboe_term_regime_overnight_btc_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "9ceb718fe3374e50d24e6df2b8e07f426217eb5779e6134ddc6254c66bddb32b"
CONTROL_DIR = Path("data/cboe_term_regime_overnight_btc_relay_controls_2023_2026")
FREEZE = Path("results/cboe_term_regime_overnight_btc_relay_economic_evaluator_freeze_2026-08-08.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/cboe_term_regime_overnight_btc_relay_{stage}_economics_2026-08-08.json")
    for stage in STAGES
}
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("CVTBR frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("CVTBR novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "cvtbr_6_sequential_economics_v1", "policy_id": POLICY_ID,
