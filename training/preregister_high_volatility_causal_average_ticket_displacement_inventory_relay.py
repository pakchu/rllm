"""Outcome-blind preregistration for HVCATDIR-8."""
...
POLICY_ID = "HVCATDIR-8"
DEFAULT_OUTPUT = Path("results/high_volatility_causal_average_ticket_displacement_inventory_relay_preregistration_2026-08-16.json")
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_causal_average_ticket_displacement_inventory_relay_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            "claim": "When BTC perpetual average quote ticket size accelerates unusually, the completed directional displacement is in a causal upper tail, realized variation is elevated, and open interest expands, large transactions and fresh leveraged directional repricing sponsor continuation for eight hours.",
            "side": "strict sign of the completed eight-hour BTC perpetual return",
            "why_distinct": "HVCATDIR combines average-ticket acceleration with an independently ranked absolute completed return, exact OI expansion, and realized variation. No prior composite event set or control is reused; it uses no taker-flow sign, spot, alt, funding, premium-index, fitted outcome, or promoted control.",
        ...
        "features": {
            ...
            "absolute_displacement_rank": "strict-prior midrank of abs(completed_return) over at most 270 source-valid cycles; current excluded; minimum 180; rank>=0.60",
        ...
        "policy": {
            ...
            "absolute_displacement_rank_min": 0.60,
        ...
        "research_boundary": {
            ...
            "prior_composite_attempt_outcomes_known": True,
        ...
        "stopping_rule": "terminal first failure; no OI endpoint or expansion rule, average-ticket acceleration formula, absolute-displacement rank, rank histories, side, clock, hold, subset, threshold, comparator, or control repair",
    }
