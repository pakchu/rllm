"""Sequential strict economics for frozen HVECO-24."""
...
PREREG = Path("results/high_volatility_ehlers_cybernetic_oscillator_zero_cross_relay_preregistration_2026-08-11.json")
PREREG_SHA = "ab893e77036f113b16553fbb15b3f594f59af13990f362c2da2d5eb0b9fad6b4"
SUPPORT = Path("results/high_volatility_ehlers_cybernetic_oscillator_zero_cross_relay_support_2026-08-11.json")
SUPPORT_SHA = "a244790d37a5112e5ea35176af0d5b1599645b277f92bd504bc4334483c912bf"
NOVELTY = Path("results/high_volatility_ehlers_cybernetic_oscillator_zero_cross_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "5525817888c34fb717d451b6478c7275e2fc9d98a903553eb42d71d8baf4dfca"
CLOCK = Path("data/high_volatility_ehlers_cybernetic_oscillator_zero_cross_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "b40e5783728bb7c91f3600785d1607f58bb68ba111883a9996494123c71c8417"
CONTROL_DIR = Path("data/high_volatility_ehlers_cybernetic_oscillator_zero_cross_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_ehlers_cybernetic_oscillator_zero_cross_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_ehlers_cybernetic_oscillator_zero_cross_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
CONTROLS = ("no_variation_gate", "long_250_20_cybernetic", "oscillator_roc_turn", "direction_flip")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVECO frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVECO novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hveco_24_sequential_economics_v1", "policy_id": POLICY_ID,
