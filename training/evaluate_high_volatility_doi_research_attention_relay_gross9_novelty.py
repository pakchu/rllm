"""Evaluate frozen HVDRA-24 structural novelty against every Gross9 sleeve."""
...
POLICY = "HVDRA-24"
PROTOCOL = "hvdra_24_gross9_novelty_v1"
PREREG = Path(
    "results/high_volatility_doi_research_attention_relay_preregistration_2026-08-12.json"
)
...
OUTPUT = Path(
    "results/high_volatility_doi_research_attention_relay_gross9_novelty_2026-08-12.json"
)
LIMITS = {
...
def run(output: Path = OUTPUT) -> dict[str, Any]:
    ...
    core = {
        ...
        "failure_action": (
            None if advance else "reject HVDRA-24 unchanged before economic outcomes"
        ),
    }
