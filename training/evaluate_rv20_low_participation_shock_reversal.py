#!/usr/bin/env python3
"""Frozen RV20 low-participation shock-reversal candidate evaluator.
...
PREREGISTRATION = Path(
    "results/rv20_low_participation_shock_reversal_preregistration_2026-08-08.json"
)
EXPECTED_PREREGISTRATION_SHA256 = (
    "32b87eac9e6f1012d6c2e17ad6bc173433ef4a5d947da31a7e8f095374b152f9"
)
OUTPUT = Path("results/rv20_low_participation_shock_reversal_evaluation_2026-08-08.json")
REPORT = Path("docs/rv20-low-participation-shock-reversal-evaluation-2026-08-08.md")
ATTEMPT = Path(
    "results/rv20_low_participation_shock_reversal_evaluation_attempt_consumed_2026-08-08.json"
)
...
ENTRY_COST = 0.0006
STRESS_COST = 0.0010
CANDIDATE = "rv20_low_participation_shock_reversal"
...
def load_preregistration(path: str | Path = PREREGISTRATION) -> dict[str, Any]:
    ...
    if payload.get("schema") != "rllm.rv20-low-participation-shock-reversal.preregistration.v1":
...
def render_markdown(payload: Mapping[str, Any]) -> str:
    ...
    lines = [
        "# RV20 Low-Participation Shock Reversal Evaluation\n\n"
...
def _execution_config(
    ...
    return ExecutionConfig(
        ...
        output="/tmp/no_write_rv20_low_participation_shock_reversal.json",
        manifest_output="/tmp/no_write_rv20_low_participation_shock_reversal_manifest.json",
...
def _install_candidate_sleeve() -> None:
    ...
    portfolio.FAMILIES[CANDIDATE] = "rv20_low_participation_shock_reversal"
...
def evaluate_frozen_protocol(
    ...
    if top is None:
        return {
            "schema": "rllm.rv20-low-participation-shock-reversal.evaluation.v1",
    ...
    if selected_leverage is None:
        return {
            "schema": "rllm.rv20-low-participation-shock-reversal.evaluation.v1",
            "tested_structural_cells": 384, "structural_rows": structural_rows,
