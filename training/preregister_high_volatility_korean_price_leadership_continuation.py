"""Outcome-blind preregistration for HVKPLC-8."""
...
POLICY_ID = "HVKPLC-8"
DEFAULT_OUTPUT = Path(
    "results/high_volatility_korean_price_leadership_continuation_preregistration_2026-08-16.json"
)
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_korean_price_leadership_continuation_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            ...
            "side": "common strict sign of Binance perpetual and FX-adjusted Upbit completed returns",
            "why_distinct": (
                "HVKPLC uses within-cycle variance decay and an efficiency ordering. Prior temporal-variance "
            ...
            "why_low_gross9_overlap_is_plausible": "FX-adjusted Korean cash leadership is absent from Gross9 primitives",
        },
        "features": {
            ...
            "binance_return": "sum of 480 one-minute Binance perpetual ln(close/open) returns, strict nonzero",
            "upbit_krw_return": "sum of synchronized 480 one-minute Upbit KRW-BTC ln(close/open) returns, strict nonzero",
            "usdkrw_return": "ln(close[D-1m]/open[D-8h]) from exact bars_polygon USDKRW endpoint rows; no fill",
            "upbit_implied_usd_return": "upbit_krw_return-usdkrw_return, strict nonzero",
            "direction_agreement": "binance_return and upbit_implied_usd_return have one strict sign",
            "korean_price_leadership": "sign(binance_return)*(upbit_implied_usd_return-binance_return)>0, strict with no fitted magnitude threshold",
        ...
        "source_plan": {
            "bars": "Postgres bars_binance BTCUSDT, bars_upbit KRW-BTC, and bars_polygon USDKRW exact one-minute endpoint data",
            "window": ["2023-04-01T00:00:00Z", "2026-08-01T00:00:00Z"],
            "read_after_preregistration": True,
            "execution_prices": "sealed until source support and Gross9 pass",
        },
        "research_boundary": {
            "prior_korean_cross_venue_source_failures_known": True,
            "prior_cross_venue_family_outcomes_known": True,
            "exact_fx_adjusted_korean_price_leadership_incidence_or_outcomes_known": False,
        ...
        "stopping_rule": (
            "terminal first failure; no endpoint synchronization, FX adjustment, Korean leadership ordering, variation history, side, "
...
def validate(value: Mapping[str, Any]) -> None:
    if value != build():
        raise RuntimeError("HVKPLC-8 preregistration drift")
