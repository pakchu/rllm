...
def build() -> dict[str, Any]:
    ...
    core = {
        ...
        "database_contract": {"env_file": "/home/pakchu/rllm/.env", "tables": ["bars_binance", "open_interest_binance", "funding_rates_binance", "bars_binance_premium"], "symbol": "BTCUSDT", "read_only": True},
