"""Outcome-blind preregistration for HVCATFIR-8."""
...
POLICY_ID = "HVCATFIR-8"
DEFAULT_OUTPUT = Path("results/high_volatility_causal_average_ticket_flow_inventory_relay_preregistration_2026-08-16.json")
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_causal_average_ticket_flow_inventory_relay_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            "claim": "When BTC perpetual average quote ticket size accelerates unusually from the first to the second four-hour half, late aggressive quote flow agrees with the completed return, realized variation is elevated, and open interest expands, large directional transactions and fresh leveraged inventory sponsor the completed direction for eight hours.",
            "side": "strict sign of the completed eight-hour BTC perpetual return",
            "why_distinct": "HVCATFIR requires within-cycle acceleration in quote turnover per transaction and independently confirms the completed direction with second-half aggressive quote flow, plus exact OI expansion and variation. No prior composite event set or control is reused; it uses no spot, ETH, funding, premium-index, fitted outcome, or promoted control.",
        ...
        "stopping_rule": "terminal first failure; no OI endpoint or expansion rule, average-ticket acceleration formula, aggressive-flow confirmation, acceleration or variation history, side, clock, hold, subset, threshold, comparator, or control repair",
    }
