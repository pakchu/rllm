"""Sequential strict economics for frozen HVCABBD-8."""
...
PREREG = Path("results/high_volatility_cross_alt_broad_barrier_discovery_relay_preregistration_2026-08-13.json")
PREREG_SHA = "1535319ea5dd66239e814649f82901b0d87b84cb923f8a189e4550c02bd3902c"
SUPPORT = Path("results/high_volatility_cross_alt_broad_barrier_discovery_relay_support_2026-08-13.json")
SUPPORT_SHA = "5cf2ec60ee58593326e3622e2964e5439c6ae8f7c0c84f8a581310a945e30de5"
NOVELTY = Path("results/high_volatility_cross_alt_broad_barrier_discovery_relay_gross9_novelty_2026-08-13.json")
NOVELTY_SHA = "5b5b58568170ba2c3a946ba07a574f3a04f5a6a07d6df09d4b5e50562b0a6192"
CLOCK = Path("data/high_volatility_cross_alt_broad_barrier_discovery_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "69cf6a1e47ce675e505f1e54c35072c4a1c999359f2ce297517e77d224e772e7"
CONTROL_DIR = Path("data/high_volatility_cross_alt_broad_barrier_discovery_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_cross_alt_broad_barrier_discovery_relay_economic_evaluator_freeze_2026-08-13.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_cross_alt_broad_barrier_discovery_relay_{stage}_economics_2026-08-13.json")
    for stage in STAGES
}
CONTROLS = ("no_variation_gate", "three_of_six_discovery", "current_bar_high_low_break", "one_bar_stale_discovery", "direction_flip", "forced_long")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVCABBD frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVCABBD novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvcabbd_8_sequential_economics_v1", "policy_id": POLICY_ID,
