"""Sequential strict economics for frozen HVEDR-6."""
...
PREREG = Path("results/high_volatility_eth_disagreement_resolution_relay_preregistration_2026-08-09.json")
PREREG_SHA = "e7dd81eb29804c9a7171c919b3c4e762a15e8febb0294780e3d2a726f5752b87"
SUPPORT = Path("results/high_volatility_eth_disagreement_resolution_relay_support_2026-08-08.json")
SUPPORT_SHA = "4b2d4f7ccaf323b98d82c504c60acf7d8343acd23feed290ae6ddcd450bb0d07"
NOVELTY = Path("results/high_volatility_eth_disagreement_resolution_relay_gross9_novelty_2026-08-09.json")
NOVELTY_SHA = "8463bb61c08741c07a4e01882fc122b668a1a78cd3cc8ac9c017ac1380fb4d08"
CLOCK = Path("data/high_volatility_eth_disagreement_resolution_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "93ad29355cfe0b7e2701f01ed6aac8ceaf6ffe0514765c2eda60fcde47466ca9"
CONTROL_DIR = Path("data/high_volatility_eth_disagreement_resolution_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_eth_disagreement_resolution_relay_economic_evaluator_freeze_2026-08-09.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_eth_disagreement_resolution_relay_{stage}_economics_2026-08-09.json")
    for stage in STAGES
}
CONTROLS = ("no_volatility_gate", "no_spread_tail_gate", "no_direction_disagreement_gate", "one_boundary_stale_geometry", "direction_fade")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvedr_6_sequential_economics_v1", "policy_id": POLICY_ID,
