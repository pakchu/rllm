"""Sequential strict economics for frozen HVDCSATA-8."""
...
PREREG = Path("results/high_volatility_directional_change_scarcity_average_ticket_acceleration_relay_preregistration_2026-08-16.json")
PREREG_SHA = "db199397e05a91d4911a67ff2b87dbe3919d8fb21e80c20c7330c3daa7dd9246"
SUPPORT = Path("results/high_volatility_directional_change_scarcity_average_ticket_acceleration_relay_support_2026-08-16.json")
SUPPORT_SHA = "9c73001b2a6ee372117a4d2aa30878e9652c615e90508e8539410777433e6805"
NOVELTY = Path("results/high_volatility_directional_change_scarcity_average_ticket_acceleration_relay_gross9_novelty_2026-08-16.json")
NOVELTY_SHA = "17cf4da5e44025437a77a1d67622bff4904593b8d6ad5234ec8cf4fbb2451e5b"
CLOCK = Path("data/high_volatility_directional_change_scarcity_average_ticket_acceleration_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "dd9f9d7c5d9b8e3fe755c97b751cc1414738ad2878c6ebabfcd7fce95b257938"
CONTROL_DIR = Path("data/high_volatility_directional_change_scarcity_average_ticket_acceleration_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_directional_change_scarcity_average_ticket_acceleration_relay_economic_evaluator_freeze_2026-08-16.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_directional_change_scarcity_average_ticket_acceleration_relay_{stage}_economics_2026-08-16.json")
    for stage in STAGES
}
CONTROLS = ("no_average_ticket_acceleration_gate", "no_directional_change_scarcity_tail", "no_variation_gate", "raw_directional_changes_at_most_478", "one_block_stale_geometry", "direction_flip", "forced_long")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVDCSATA frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVDCSATA novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvdcsata_8_sequential_economics_v1", "policy_id": POLICY_ID,
