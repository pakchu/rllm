"""One-shot G9CB-11 source-support materializer.
...
class SourceSupportFailure(RuntimeError):
    """Terminal failure for the consumed G9CB-11 source-support identity."""


IDENTITY = "G9CB-11-SOURCE-SUPPORT"
VERSION = "gross9_structural_clock_bundle_g9cb11_source_support_v1"
...
class MaterializationConfig:
    ...
    repository_head: str = "synthetic-s11"
    repository_parent: str = T10
    authority_commit: str = A11
    branch: str = BRANCH
...
def official_config(root: Path | None = None) -> MaterializationConfig:
    ...
    return MaterializationConfig(
        ...
        attempt_path="results/gross9_structural_clock_bundle_g9cb11_source_support_attempt_consumed_2026-07-31.json",
        market_output_path="data/cache_market_ext_5m_wavefull_2020-01-01_2026-06-01_g9cb11_complete.csv.gz",
        oi_output_path="data/btcusdt_open_interest_5m_2020-01-01_2026-06-01_g9cb11_complete.csv.gz",
        manifest_output_path="configs/shadow/gross9_structural_clock_bundle_g9cb11_sources_2026-07-31.json",
        support_output_path="results/gross9_structural_clock_bundle_g9cb11_source_support_2026-07-31.json",
...
def _validate_git_gate(config: MaterializationConfig) -> str:
    ...
    if len(parents) != 2 or parents[1] != T10:
        _fail("S11 direct parent differs")
    if _run_git(root, "rev-parse", f"{T10}^") != A11:
        _fail("T10/A11 topology differs")
    if _run_git(root, "rev-parse", f"{A11}^") != S10:
        _fail("A11/S10 topology differs")
    if _run_git(root, "rev-parse", f"{S10}^") != T9:
        _fail("S10/T9 topology differs")
    if _run_git(root, "diff", "--name-status", S10, A11).splitlines() != [
        "A\tdocs/gross9-structural-clock-bundle-g9cb11-successor-authority-decision-2026-07-31.md"
    ]:
        _fail("exact A11 one-file diff differs")
    if sorted(_run_git(root, "diff", "--name-status", A11, T10).splitlines()) != [
        ...
        _fail("exact T10 two-file diff differs")
    expected = [
    ...
    actual = sorted(_run_git(root, "diff", "--name-status", T10, head).splitlines())
    if actual != expected:
        _fail("exact S11 two-file diff differs")
    for entry in expected:
        ...
        if len(indexed) < 4 or indexed[0] != "100644" or indexed[2] != "0" or indexed[3] != relative:
            _fail(f"S11 Git mode or index binding differs: {relative}")
...
_A11_AUTHORITY = (
    "docs/gross9-structural-clock-bundle-g9cb11-successor-authority-decision-2026-07-31.md",
    53139,
    "c04ee41e030edf3a043f9a5eddb0117de9dd5513769e919c13bd15a5747d18f1",
    "cf271058c0c75d57d08cdae7b7346ec9129adfee",
)
_A10_AUTHORITY = (
...
_T10_EVIDENCE = (
    (
        ...
        3056,
        "2f3ea59c815ec36c64bcacc4ddabac12165cb6b04e38ca300532a754e1522796",
        "7a0da42c5c37ce8cc275715b819f5d9db712d279",
    ),
    (
        "results/gross9_structural_clock_bundle_g9cb10_source_support_terminal_failure_2026-07-31.json",
        4198,
        "01f99da7b06cb9195159bfedec646a22765368140d174567cb9052d24aa58ea4",
        "b7fc8bc4ed3d6f1cd63289d22936c52a2931bf75",
    ),
)
_G9CB10_PERMANENT_ABSENCES = (
...
_T10_TERMINAL_LITERAL = json.loads('{"access":{"attempt_sentinel_publication_count":1,"binance_metrics_open_interest_decode_count":1,"cagr_evaluation_count":0,"candidate_value_rows_opened":0,"comparator_value_rows_opened":0,"decode_pass_count":8,"decode_passes":["old_market","replacement_market_date_scan","replacement_market_tail","funding","premium","old_open_interest","binance_metrics_open_interest","rank7_spot_premium_5m"],"drawdown_evaluation_count":0,"economic_evaluation_count":0,"economic_value_rows_opened":0,"feature_value_rows_opened":0,"generated_output_publication_count":0,"generated_output_readback_count":0,"global_metrics_alignment_check_count":1,"mdd_evaluation_count":0,"off_grid_detail_disclosure_count":0,"pnl_value_rows_opened":0,"raw_file_count":7,"raw_file_open_count":7,"replacement_market_date_scan_count":1,"replacement_market_tail_decode_count":1,"replacement_market_tail_selected_row_count":107,"return_value_rows_opened":0,"schedule_value_rows_opened":0,"signal_value_rows_opened":0},"attempt_sentinel":{"attempt_hash":"ba52b19400d399ecedd09be6ceecc0605aeb959ec425df262ddbff590a0661c2","device":2096,"filesystem_type":"regular_file","git_mode":"100644","inode":656585,"link_count":1,"one_shot":true,"opaque_bytes_hashed_before_publication":190272610,"path":"results/gross9_structural_clock_bundle_g9cb10_source_support_attempt_consumed_2026-07-31.json","raw_input_count":7,"repository_head":"1079c3575c7e7dced52eea15e1ef35ae0171a5dd","repository_parent":"a3ce195b02598b139068294089695b5d5dcd5044","resume_allowed":false,"retry_allowed":false,"sha256":"2f3ea59c815ec36c64bcacc4ddabac12165cb6b04e38ca300532a754e1522796","size_bytes":3056,"worktree_mode":"0444"},"authority":{"commit":"6f9dd21554bc7b3282d0b2cbf7badee126e75c1a","document_path":"docs/gross9-structural-clock-bundle-g9cb10-successor-authority-decision-2026-07-31.md"},"execution":{"command":"PYTHONPATH=$PWD PYTHONDONTWRITEBYTECODE=1 uv run python -B -m training.materialize_gross9_structural_clock_g9cb10_sources","exit_status":1,"invocation_count":1,"one_shot":true,"resume_allowed":false,"retry_allowed":false},"failure":{"exception_class":"SourceSupportFailure","exception_message":"off-grid timestamps: binance_metrics_open_interest","off_grid_count_disclosed":false,"off_grid_detail_disclosure_count":0,"off_grid_location_disclosed":false,"off_grid_timestamp_disclosed":false,"off_grid_value_disclosed":false,"phase":"transform","traceback_source_value_excerpt_emitted":false},"identity":"G9CB-10-SOURCE-SUPPORT","implementation":{"commit":"1079c3575c7e7dced52eea15e1ef35ae0171a5dd","files":[{"git_blob":"a7bd897f79e3425e28adfcef28b40fb9eb373340","git_mode":"100644","path":"training/materialize_gross9_structural_clock_g9cb10_sources.py","sha256":"67e6ed5bbbc80e532c2fe706e4fd43ad3352400cc8e87669efa51363f0dd3915","size_bytes":73480,"worktree_mode":"0644"},{"git_blob":"6e7e5a9904e7f04145361df9814e31854ed378f2","git_mode":"100644","path":"tests/test_materialize_gross9_structural_clock_g9cb10_sources.py","sha256":"765a3c73cb5ea836916463fc6b134378a811234fba374831bde36ba53d3a9c6e","size_bytes":84505,"worktree_mode":"0644"}],"parent_commit":"a3ce195b02598b139068294089695b5d5dcd5044"},"ledger_kind":"gross9_structural_clock_bundle_g9cb10_source_support_terminal_failure_v1","output_state":{"downstream_consumable":false,"forbidden_stages":["M10","Q10","P10","C10","D10","V10","H10"],"permanently_absent_output_paths":["data/cache_market_ext_5m_wavefull_2020-01-01_2026-06-01_g9cb10_complete.csv.gz","data/btcusdt_open_interest_5m_2020-01-01_2026-06-01_g9cb10_complete.csv.gz","configs/shadow/gross9_structural_clock_bundle_g9cb10_sources_2026-07-31.json","results/gross9_structural_clock_bundle_g9cb10_source_support_2026-07-31.json"],"source_authoritative":false,"terminal_evidence_paths":["results/gross9_structural_clock_bundle_g9cb10_source_support_attempt_consumed_2026-07-31.json"]},"schema_version":1,"seal_authority":{"commit":"189b5403c66ea0283e67b42b9fbc6ba909280a57","document_path":"docs/gross9-structural-clock-bundle-g9cb11-successor-authority-decision-2026-07-31.md"},"status":"terminal_metrics_timestamp_alignment_failure","terminal_failure_hash":"c62e8f61ed0995174e3d6997970c4a6fd8c69d8bc4947a9141de26e5dd1a55ca"}')
_T9_EVIDENCE = (
    (
...
def _validate_history_gate(config: MaterializationConfig) -> None:
    a11_path, a11_size, a11_digest, a11_blob = _A11_AUTHORITY
    a11_fd = _open_nofollow_components(config.root / a11_path, os.O_RDONLY)
    try:
        a11_info = os.fstat(a11_fd)
        a11_raw = _pread_complete(a11_fd, a11_info.st_size)
    finally:
        os.close(a11_fd)
    if (
        not stat.S_ISREG(a11_info.st_mode)
        or stat.S_IMODE(a11_info.st_mode) != 0o644
        or a11_info.st_nlink != 1
        or a11_info.st_size != a11_size
        or hashlib.sha256(a11_raw).hexdigest() != a11_digest
        or _run_git(config.root, "ls-files", "-s", "--", a11_path).split()
        != ["100644", a11_blob, "0", a11_path]
    ):
        _fail("A11 authority binding differs")
    ...
    g9cb10_attempt = _read_bound_json(config, *_T10_EVIDENCE[0], mode=0o444)
    g9cb10_terminal = _read_bound_json(config, *_T10_EVIDENCE[1], mode=0o444)
    g9cb10_attempt_info = os.lstat(config.root / _T10_EVIDENCE[0][0])
    if (
        (g9cb10_attempt_info.st_dev, g9cb10_attempt_info.st_ino) != (2096, 656585)
        or g9cb10_attempt.get("identity") != "G9CB-10-SOURCE-SUPPORT"
        or g9cb10_attempt.get("repository_head") != S10
        or g9cb10_attempt.get("repository_parent") != T9
        or g9cb10_attempt.get("attempt_hash")
        != "ba52b19400d399ecedd09be6ceecc0605aeb959ec425df262ddbff590a0661c2"
        or g9cb10_attempt.get("expected_outputs")
        != [_T10_EVIDENCE[0][0], *_G9CB10_PERMANENT_ABSENCES]
        or g9cb10_attempt.get("raw_inputs")
        != [
            {
                "mode_octal": f"{row.mode:04o}", "name": row.name,
                "path": row.path, "path_type": "regular_file",
                "sha256": row.sha256, "size_bytes": row.size_bytes,
            }
            for row in OFFICIAL_INPUTS
        ]
    ):
        _fail("G9CB-10 attempt sentinel constants differ")
    if (
        set(g9cb10_terminal) != {
            "schema_version", "ledger_kind", "identity", "status", "authority",
            "seal_authority", "implementation", "attempt_sentinel", "execution",
        ...
        or object_hash(g9cb10_terminal, "terminal_failure_hash")
        != g9cb10_terminal.get("terminal_failure_hash")
        or g9cb10_terminal.get("identity") != "G9CB-10-SOURCE-SUPPORT"
        or g9cb10_terminal.get("terminal_failure_hash")
        != "c62e8f61ed0995174e3d6997970c4a6fd8c69d8bc4947a9141de26e5dd1a55ca"
        or g9cb10_terminal.get("seal_authority")
        != {"commit": A11, "document_path": a11_path}
    ):
        _fail("T10 terminal ledger constants differ")
    for relative in _G9CB10_PERMANENT_ABSENCES:
        path = config.root / relative
        if path.exists() or path.is_symlink():
            _fail(f"permanent G9CB-10 absence differs: {relative}")
...
def _expected_access_ledger(
    ...
    historical_s9 = {
        "identity": "G9CB-9-SOURCE-SUPPORT",
        "attempt_sentinel": {
            "path": _T9_EVIDENCE[0][0], "sha256": _T9_EVIDENCE[0][2],
            "size_bytes": _T9_EVIDENCE[0][1],
            "attempt_hash": "fa7c7df3d7ab8b7622b9c954741330dfbbe5182599e441f63459e2249d4a2887",
            "git_blob": _T9_EVIDENCE[0][3], "git_mode": "100644", "seal_commit": T9,
        },
        "terminal_failure_ledger": {
            "path": _T9_EVIDENCE[1][0], "sha256": _T9_EVIDENCE[1][2],
            "size_bytes": _T9_EVIDENCE[1][1],
            "terminal_failure_hash": "29ca03ab230e644499fd28704dffa75c38091ad597a72cd6c7e90ef7dfd3ef78",
            "git_blob": _T9_EVIDENCE[1][3], "git_mode": "100644", "seal_commit": T9,
        },
        "official_invocation_count": 1, "exit_status": 1, "raw_file_count": 7,
        "decode_pass_count": 7, "market_prefix_comparison_count": 1,
        "mismatch_fraction_percent": "0.00148", "traceback_value_excerpt_emitted": True,
        "traceback_value_excerpt_restated_in_ledger": False,
        "generated_readback_decode_count": 0, "candidate_rows_opened": 0,
        "comparator_clock_rows_opened": 0,
        "feature_signal_schedule_or_interval_values_computed": 0,
        "economic_or_overlap_values_computed": 0,
    }
    terminal = json.loads(json.dumps(_T10_TERMINAL_LITERAL))
    historical_s10 = {
        "identity": terminal["identity"], "status": terminal["status"],
        "authority": terminal["authority"], "seal_authority": terminal["seal_authority"],
        "implementation": terminal["implementation"],
        "attempt_sentinel": terminal["attempt_sentinel"],
        "terminal_ledger": {
            "path": _T10_EVIDENCE[1][0], "commit": T10,
            "size_bytes": _T10_EVIDENCE[1][1], "sha256": _T10_EVIDENCE[1][2],
            "git_blob": _T10_EVIDENCE[1][3], "git_mode": "100644",
            "worktree_mode": "0444", "terminal_failure_hash": terminal["terminal_failure_hash"],
        },
        "execution": terminal["execution"], "failure": terminal["failure"],
        "access": terminal["access"], "output_state": terminal["output_state"],
    }
    decode_passes = [
    ...
    current_access = {
        ...
        "generated_output_publication_count": 4, "generated_output_readback_count": 2,
        "off_grid_detail_disclosure_count": 0, **zero_economics,
    }
    current_s11 = {
        "identity": IDENTITY,
        "authority": {"commit": config.authority_commit, "document_path": _A11_AUTHORITY[0]},
        "implementation": {
        ...
        "execution": {
            ...
            "invocation_count": 1, "one_shot": True, "retry_allowed": False,
            "resume_allowed": False,
        },
    ...
    process_local = {
        "stage": "S11", "slot": 0, "invocation_count": 1,
        "raw_file_count": 7, "raw_file_open_count": 7, "decode_pass_count": 9,
        ...
        "source_value_rows_opened": sum(addends),
        "non_selected_metrics_non_date_semantic_evaluation_count": 0,
        "global_metrics_alignment_comparison_count": 0,
        "generated_output_readback_count": 2, "off_grid_detail_disclosure_count": 0,
        **zero_economics,
    }
    outputs9 = [
        "results/gross9_structural_clock_bundle_g9cb9_source_support_attempt_consumed_2026-07-31.json",
    ...
    outputs10 = [_T10_EVIDENCE[0][0], *_G9CB10_PERMANENT_ABSENCES]
    outputs11 = list(config.output_paths)
    identities = {
        "historical_s9": "G9CB-9-SOURCE-SUPPORT",
        "historical_s10": "G9CB-10-SOURCE-SUPPORT", "current_s11": IDENTITY,
    }
    attempt_hashes = {
        "historical_s9": historical_s9["attempt_sentinel"]["attempt_hash"],
        "historical_s10": terminal["attempt_sentinel"]["attempt_hash"],
        "current_s11": attempt["attempt_hash"],
    }
    intersections = {
        "historical_s9_historical_s10": sorted(set(outputs9) & set(outputs10)),
        "historical_s9_current_s11": sorted(set(outputs9) & set(outputs11)),
        "historical_s10_current_s11": sorted(set(outputs10) & set(outputs11)),
    }
    if any(intersections.values()) or len(set(identities.values())) != 3 or len(set(attempt_hashes.values())) != 3:
        _fail("G9CB-11 replay guard inputs differ")
    replay_guard = _with_hash({
        "a11": {"commit": config.authority_commit, "authority_document_path": _A11_AUTHORITY[0]},
        "t10": {
            "commit": config.repository_parent, "attempt_sentinel_path": _T10_EVIDENCE[0][0],
            "attempt_hash": terminal["attempt_sentinel"]["attempt_hash"],
            "terminal_ledger_path": _T10_EVIDENCE[1][0],
            "terminal_ledger_sha256": _T10_EVIDENCE[1][2],
            "terminal_failure_hash": terminal["terminal_failure_hash"],
        },
        "s11": {
            "commit": head, "parent_commit": config.repository_parent,
            "implementation_paths": current_s11["implementation"]["paths"],
            "attempt_sentinel_path": config.attempt_path,
            "attempt_hash": attempt["attempt_hash"],
        },
        "identities": identities, "attempt_hashes": attempt_hashes,
        "terminal_failure_hashes": {
            "historical_s9": historical_s9["terminal_failure_ledger"]["terminal_failure_hash"],
            "historical_s10": terminal["terminal_failure_hash"],
        },
        "expected_output_paths": {
            "historical_s9": outputs9, "historical_s10": outputs10, "current_s11": outputs11,
        },
        "pairwise_output_intersections": intersections,
        "identities_pairwise_distinct": True, "attempt_hashes_pairwise_distinct": True,
    }, "replay_guard_hash")
    return _with_hash({
        "schema_version": 1,
        "ledger_kind": "gross9_structural_clock_bundle_g9cb11_access_v1",
        "historical_s9": historical_s9, "historical_s10": historical_s10,
        "current_s11": current_s11, "process_local": process_local,
...
def materialize(config: MaterializationConfig, *, failpoint: Callable[[str], None] | None = None) -> dict[str, Any]:
    ...
    if invocation_key in _PROCESS_LOCAL_CONSUMED_INVOCATIONS:
        _fail("one-shot invocation already exists and cannot be retried")
    ...
    try:
        ...
        for binding in config.inputs:
            if binding.name == "replacement_market":
                ...
                metrics_scan = _scan_metrics_dates(retained[binding.name], config, inject)
                frame, schema = _decode_metrics_selected_window(
                    retained[binding.name], metrics_scan, inject
                )
        ...
        market, oi, validation, normalized_rows = _transform(
            config, frames, schemas, replacement_scan, metrics_scan
        )
        frames.clear()
        schemas.clear()
        del frame, schema
        ...
        for slot, item in enumerate(retained.values()):
            _final_reauthenticate_input(item, slot, inject)
