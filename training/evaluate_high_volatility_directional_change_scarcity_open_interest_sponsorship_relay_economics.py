"""Sequential strict economics for frozen HVDCSOIS-8."""
...
PREREG = Path("results/high_volatility_directional_change_scarcity_open_interest_sponsorship_relay_preregistration_2026-08-16.json")
PREREG_SHA = "098c6e713e8db00eef987911170783b81eaac7ffa34b2e4bbdcacd254e16152a"
SUPPORT = Path("results/high_volatility_directional_change_scarcity_open_interest_sponsorship_relay_support_2026-08-16.json")
SUPPORT_SHA = "515be700014fb34f0a952abc40c7741254a6bdbf2f2ca4e1753b7d894593619c"
NOVELTY = Path("results/high_volatility_directional_change_scarcity_open_interest_sponsorship_relay_gross9_novelty_2026-08-16.json")
NOVELTY_SHA = "ffe6d1f15310243b54780d1db00dc0004371b0e54eca197b100bde6bd529ba02"
CLOCK = Path("data/high_volatility_directional_change_scarcity_open_interest_sponsorship_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "3483ef0066dd8411f6a6fa23ce1af88b698d41233d4dfa78e2e9a7e596242c5b"
CONTROL_DIR = Path("data/high_volatility_directional_change_scarcity_open_interest_sponsorship_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_directional_change_scarcity_open_interest_sponsorship_relay_economic_evaluator_freeze_2026-08-16.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_directional_change_scarcity_open_interest_sponsorship_relay_{stage}_economics_2026-08-16.json")
    for stage in STAGES
}
CONTROLS = ("no_open_interest_sponsorship_gate", "no_directional_change_scarcity_tail", "no_variation_gate", "raw_directional_changes_at_most_478", "one_block_stale_geometry", "direction_flip", "forced_long")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVDCSOIS frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVDCSOIS novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvdcs_ois_8_sequential_economics_v1", "policy_id": POLICY_ID,
