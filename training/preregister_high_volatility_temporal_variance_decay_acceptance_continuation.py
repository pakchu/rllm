"""Outcome-blind preregistration for HVTVDAC-8."""
...
POLICY_ID = "HVTVDAC-8"
DEFAULT_OUTPUT = Path(
    "results/high_volatility_temporal_variance_decay_acceptance_continuation_preregistration_2026-08-16.json"
)
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_temporal_variance_decay_acceptance_continuation_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            ...
            "why_distinct": (
                "HVTVDAC uses within-cycle variance decay and an efficiency ordering. Prior temporal-variance "
            ...
            "why_low_gross9_overlap_is_plausible": "variance-decay plus directional-efficiency ordering is absent from Gross9 primitives",
        },
        "features": {
            ...
            "first_half_qv": "sum squared minute returns over the first 240 bars, strict positive",
            "second_half_qv": "sum squared minute returns over the final 240 bars, strict positive and strictly below first_half_qv",
            "first_half_efficiency": "abs(first_half_return)/sqrt(first_half_qv), finite",
            "second_half_efficiency": "abs(second_half_return)/sqrt(second_half_qv), finite and strictly above first_half_efficiency",
        ...
        "source_plan": {
            "bars": "Postgres bars_binance BTCUSDT exact coherent interval=1m OHLC",
            "window": ["2023-04-01T00:00:00Z", "2026-08-01T00:00:00Z"],
            "read_after_preregistration": True,
            "execution_prices": "sealed until source support and Gross9 pass",
        },
        "research_boundary": {
            "prior_temporal_variance_ignition_source_failure_known": True,
            "prior_time_structure_family_outcomes_known": True,
            "exact_variance_decay_efficiency_acceptance_incidence_or_outcomes_known": False,
        ...
        "stopping_rule": (
            "terminal first failure; no variance ordering, efficiency ordering, variation history, side, "
...
def validate(value: Mapping[str, Any]) -> None:
    if value != build():
        raise RuntimeError("HVTVDAC-8 preregistration drift")
