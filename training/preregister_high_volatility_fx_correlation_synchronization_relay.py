"""Outcome-blind preregistration for HVFXCSR-12."""
from __future__ import annotations
import argparse, hashlib, json
from pathlib import Path
from typing import Any

DEFAULT_OUTPUT = Path("results/high_volatility_fx_correlation_synchronization_relay_preregistration_2026-08-10.json")
...
def build() -> dict[str, Any]:
    core = {
        ...
        "diagnostic_controls": {"names": ["no_volatility_gate", "no_synchronization_gate", "one_session_stale_features", "direction_flip", "forced_long"], "diagnostic_controls_cannot_be_promoted": True},
        "research_boundary": {
