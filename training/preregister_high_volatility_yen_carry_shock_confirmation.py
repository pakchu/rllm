"""Outcome-blind preregistration for HVYCSC-8."""
...
POLICY_ID = "HVYCSC-8"
DEFAULT_OUTPUT = Path(
    "results/high_volatility_yen_carry_shock_confirmation_preregistration_2026-08-16.json"
)
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_yen_carry_shock_confirmation_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            ...
            "side": "common strict sign of completed BTC and USDJPY eight-hour returns",
            "why_distinct": (
                "HVYCSC uses within-cycle variance decay and an efficiency ordering. Prior temporal-variance "
            ...
            "why_low_gross9_overlap_is_plausible": "exact USDJPY carry-shock confirmation is absent from Gross9 primitives",
        },
        "features": {
            ...
            "btc_return": "sum of 480 exact coherent BTCUSDT minute ln(close/open) returns, strict nonzero",
            "usd_jpy_return": "ln(close[D-1m]/open[D-8h]) from exact bars_polygon USDJPY endpoint rows, strict nonzero and no fill",
            "direction_agreement": "BTC and USDJPY returns have one strict sign",
            "yen_shock_rank": "strict-prior midrank of abs(usd_jpy_return) over at most 270 source-valid cycles; current excluded; minimum 180; rank>=0.75",
        ...
        "source_plan": {
            "bars": "Postgres bars_binance BTCUSDT exact coherent 1m OHLC and bars_polygon USDJPY exact endpoints",
            "window": ["2023-04-01T00:00:00Z", "2026-08-01T00:00:00Z"],
            "read_after_preregistration": True,
            "execution_prices": "sealed until source support and Gross9 pass",
        },
        "research_boundary": {
            "prior_fx_network_barbell_factor_failures_known": True,
            "prior_fx_macro_family_outcomes_known": True,
            "exact_yen_carry_shock_confirmation_incidence_or_outcomes_known": False,
        ...
        "stopping_rule": (
            "terminal first failure; no USDJPY endpoint, shock rank, direction agreement, variation history, side, "
...
def validate(value: Mapping[str, Any]) -> None:
    if value != build():
        raise RuntimeError("HVYCSC-8 preregistration drift")
