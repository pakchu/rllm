"""Build outcome-blind source support for frozen HVPRQC-12."""
...
from training import preregister_high_volatility_relative_premium_quiescence_continuation as prereg
from training.build_binance_aggtrade_microstructure import _write_gzip_csv


ENV_FILE = "/home/pakchu/rllm/.env"
PREREG_SHA = "3a2ab8228b765f4b1e85fcd7c7b75a0929eae73bcc86794a4468d66018f488b9"
START = pd.Timestamp("2023-01-01T00:00:00Z")
END = pd.Timestamp("2026-08-01T00:00:00Z")
SOURCE_DIR = Path("data/high_volatility_relative_premium_quiescence_continuation_sources_2023_2026")
FEATURES = SOURCE_DIR / "daily_preentry_features.csv.gz"
SOURCE_MANIFEST = SOURCE_DIR / "manifest.json"
CLOCK = Path("data/high_volatility_relative_premium_quiescence_continuation_clocks_2023_2026.csv.gz")
CONTROL_DIR = Path("data/high_volatility_relative_premium_quiescence_continuation_controls_2023_2026")
RESULT = Path("results/high_volatility_relative_premium_quiescence_continuation_support_2026-08-16.json")
SPLITS = {
...
def conditions(frame: pd.DataFrame, control: str = "primary") -> tuple[pd.Series, pd.Series, pd.DataFrame]:
    ...
    premium_gate = (
        ...
        else used.relative_premium_activity_rank.le(0.25)
    )
    variation_gate = (
        pd.Series(True, index=frame.index)
...
def build_clock(features: pd.DataFrame, control: str = "primary") -> pd.DataFrame:
    ...
    for index in features.index[active]:
        ...
        rows.append({
            "candidate": "HVPRQC-12", "control": control, "split": split,
...
def run() -> dict[str, Any]:
    if sha(prereg.DEFAULT_OUTPUT) != PREREG_SHA:
        raise RuntimeError("HVPRQC preregistration drift")
    ...
    source_core = {
        "protocol_version": "hvprqc_12_sources_v1",
    ...
    core = {
        "protocol_version": "hvprqc_12_source_support_v1", "policy_id": "HVPRQC-12",
