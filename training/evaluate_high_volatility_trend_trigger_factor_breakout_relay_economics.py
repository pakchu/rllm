"""Sequential strict economics for frozen HVTTF-24."""
...
PREREG = Path("results/high_volatility_trend_trigger_factor_breakout_relay_preregistration_2026-08-11.json")
PREREG_SHA = "ec354e2f793b24e806de4e3a8faf403c4657b14f97e282be4f9e04e358446a9d"
SUPPORT = Path("results/high_volatility_trend_trigger_factor_breakout_relay_support_2026-08-11.json")
SUPPORT_SHA = "71a37510b5d42cd8850a3665ef787e0aac07583d9aa3326b95d17a5d1baae968"
NOVELTY = Path("results/high_volatility_trend_trigger_factor_breakout_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "35b45acc72c7b3f46e87395840b00ff9572eaf561ab94e27e0dc13ad22e6a221"
CLOCK = Path("data/high_volatility_trend_trigger_factor_breakout_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "e43167108b41d730d869403f7444f49bb0de8d9ccc00d47c0d8a7f07193ad076"
CONTROL_DIR = Path("data/high_volatility_trend_trigger_factor_breakout_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_trend_trigger_factor_breakout_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_trend_trigger_factor_breakout_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
CONTROLS = ("no_variation_gate", "zero_line_crossover", "one_bar_stale_trigger", "direction_flip", "forced_long")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVTTF frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVTTF novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvttf_24_sequential_economics_v1", "policy_id": POLICY_ID,
