"""Build outcome-blind source support for frozen HVPORC-8."""
...
from training import preregister_high_volatility_premium_oi_rotation_continuation_relay as prereg
from training.build_binance_aggtrade_microstructure import _write_gzip_csv


ENV_FILE = "/home/pakchu/rllm/.env"
PREREG_SHA = "18b231d2c327be7317ab213c95707c7b9fb61108028f68b14877bb98624d26ec"
...
SOURCE_DIR = Path("data/high_volatility_premium_oi_rotation_continuation_relay_sources_2023_2026")
FEATURES = SOURCE_DIR / "eight_hour_preentry_features.csv.gz"
SOURCE_MANIFEST = SOURCE_DIR / "manifest.json"
CLOCK = Path("data/high_volatility_premium_oi_rotation_continuation_relay_clocks_2023_2026.csv.gz")
CONTROL_DIR = Path("data/high_volatility_premium_oi_rotation_continuation_relay_controls_2023_2026")
RESULT = Path("results/high_volatility_premium_oi_rotation_continuation_relay_support_2026-08-13.json")
SPLITS = {
...
CONTROLS = ("no_dvol_gate", "no_premium_tail", "no_oi_expansion", "one_block_stale_features", "direction_flip", "forced_long")
PREMIUM_QUERY = """
...
def conditions(frame: pd.DataFrame, control: str = "primary") -> tuple[pd.Series, pd.Series, pd.DataFrame]:
    ...
    if control != "no_oi_expansion": active &= used.current_oi_change.gt(0)
    side = np.sign(used.current_premium_displacement).fillna(0).astype(int)
...
def run() -> dict[str, Any]:
    if sha(prereg.DEFAULT_OUTPUT) != PREREG_SHA: raise RuntimeError("HVPORC preregistration drift")
