"""Sequential strict economics for frozen HVBITOFL-24."""
...
PREREG = Path("results/high_volatility_bito_futures_flow_sponsorship_relay_preregistration_2026-08-11.json")
PREREG_SHA = "72f40737c05a08fccf5fd52100936c19f91627ce55b7a2a3f52b87ba016334df"
SUPPORT = Path("results/high_volatility_bito_futures_flow_sponsorship_relay_support_2026-08-11.json")
SUPPORT_SHA = "69e10b88f454ac10ec2b064cf9d53da54dcc7577323199dca7d571e22d78bfe7"
NOVELTY = Path("results/high_volatility_bito_futures_flow_sponsorship_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "f63c5b6d013fccdf7ce1c392e70c6916ead782f49b949dd47d1cb71b6da76c79"
CLOCK = Path("data/high_volatility_bito_futures_flow_sponsorship_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "b867da7ba0bf73dab92b72b7ad2a59e35c478e6a4547a626d408e642ca02da63"
CONTROL_DIR = Path("data/high_volatility_bito_futures_flow_sponsorship_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_bito_futures_flow_sponsorship_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_bito_futures_flow_sponsorship_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVBITOFL frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVBITOFL novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvbitofl_24_sequential_economics_v1", "policy_id": POLICY_ID,
