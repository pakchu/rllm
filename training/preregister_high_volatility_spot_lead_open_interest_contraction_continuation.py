"""Outcome-blind preregistration for HVSPOICC-8."""
...
POLICY_ID = "HVSPOICC-8"
DEFAULT_OUTPUT = Path("results/high_volatility_spot_lead_open_interest_contraction_continuation_preregistration_2026-08-16.json")
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_spot_lead_open_interest_contraction_continuation_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            "claim": "When completed BTC spot and perpetual eight-hour returns agree, spot overshoots the perpetual in that common direction, realized variation is elevated, and open interest contracts, spot-led demand is absorbing leveraged position closure and should continue over eight hours.",
            "side": "same strict sign of the completed eight-hour BTC spot and perpetual returns",
            "why_distinct": "HVSPOICC requires an exact completed-range close location with exact OI contraction and variation. No prior composite event set or control is reused; it uses no spot, ETH, funding, premium-index, fitted outcome, or promoted control.",
            "why_suited_to_volatile_regimes": "the completed eight-hour BTC realized variation must be in its causal upper 40 percent",
            "why_low_gross9_overlap_is_plausible": "fixed eight-hour spot leadership plus OI-contraction absorption states are absent from Gross9 primitives",
        },
        "features": {
            ...
            "eligible": "exact coherent synchronized 480-row spot and perpetual cycles, strict direction agreement, strict directional spot overshoot, two exact OI endpoints with strict contraction, and the variation rank passes at D",
            "no_imputation": True,
        },
        "clock": {
        ...
        "research_boundary": {
            ...
            "prior_spot_lead_OI_expansion_train_failure_known": True,
            "prior_OI_state_family_failures_known": True,
            "exact_spot_lead_OI_contraction_incidence_or_outcomes_known": False,
        ...
        "stopping_rule": "terminal first failure; no OI endpoint or contraction rule, spot-perpetual agreement or leadership rule, variation history, side, clock, hold, subset, threshold, comparator, or control repair",
    }
