"""Sequential strict economics for frozen HVMCIA-8."""
...
PREREG = Path("results/high_volatility_median_crossing_impulse_asymmetry_relay_preregistration_2026-08-10.json")
PREREG_SHA = "ae1dbe25c58d4aaafc6c101c806f371d0fc12fa812ad2cf7e133bec1ba4b2c2a"
SUPPORT = Path("results/high_volatility_median_crossing_impulse_asymmetry_relay_support_2026-08-10.json")
SUPPORT_SHA = "e8a90a2d406890a37022002f1066401618f6df8a988b5aacd19a725b374094e3"
NOVELTY = Path("results/high_volatility_median_crossing_impulse_asymmetry_relay_gross9_novelty_2026-08-10.json")
NOVELTY_SHA = "5ea95bd0cffb7d199b6245f04a1bc291e426220d1c6ef719574c21e31294b84f"
CLOCK = Path("data/high_volatility_median_crossing_impulse_asymmetry_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "9cda5fece7412eceac9cecf3b0f0f5561893a10c130c234b9e93935eb497ead2"
CONTROL_DIR = Path("data/high_volatility_median_crossing_impulse_asymmetry_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_median_crossing_impulse_asymmetry_relay_economic_evaluator_freeze_2026-08-10.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_median_crossing_impulse_asymmetry_relay_{stage}_economics_2026-08-10.json")
    for stage in STAGES
}
CONTROLS = ("no_asymmetry_tail", "no_variation_gate", "crossing_step_return_asymmetry", "one_block_stale_crossings", "direction_flip", "forced_long")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVMCIA frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVMCIA novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvmcia_8_sequential_economics_v1", "policy_id": POLICY_ID,
