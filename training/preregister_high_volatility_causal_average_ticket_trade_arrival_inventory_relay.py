"""Outcome-blind preregistration for HVCATTAIR-8."""
...
POLICY_ID = "HVCATTAIR-8"
DEFAULT_OUTPUT = Path("results/high_volatility_causal_average_ticket_trade_arrival_inventory_relay_preregistration_2026-08-16.json")
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_causal_average_ticket_trade_arrival_inventory_relay_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            "claim": "When BTC perpetual average quote ticket size accelerates unusually from the first to the second four-hour half, transaction arrivals accelerate from the first to the second four-hour half, realized variation is elevated, and open interest expands, larger tickets, faster transaction arrivals, and fresh leveraged inventory sponsor the completed direction for eight hours.",
            "side": "strict sign of the completed eight-hour BTC perpetual return",
            "why_distinct": "HVCATTAIR requires within-cycle acceleration in quote turnover per transaction and requires simultaneous acceleration in transaction arrival count, plus exact OI expansion and variation. No prior composite event set or control is reused; it uses no spot, ETH, funding, premium-index, fitted outcome, or promoted control.",
        ...
        "features": {
            ...
            "trade_arrival_acceleration": "log(second-half transaction count/first-half transaction count), finite strict positive",
        ...
        "research_boundary": {
            ...
            "same_mechanism_as_HVCATCLIR": False,
        ...
        "stopping_rule": "terminal first failure; no OI endpoint or expansion rule, average-ticket acceleration formula, trade-arrival acceleration formula, acceleration or variation history, side, clock, hold, subset, threshold, comparator, or control repair",
    }
