"""Sequential strict economics for frozen HVELRSIPSC-24."""
...
PREREG = Path("results/high_volatility_ehlers_laguerre_rsi_premium_sponsorship_reentry_relay_preregistration_2026-08-16.json")
PREREG_SHA = "e3eb99e292a6314ac06d01d902202a2df074cebf012e21c6068652a2ee14f103"
SUPPORT = Path("results/high_volatility_ehlers_laguerre_rsi_premium_sponsorship_reentry_relay_support_2026-08-16.json")
SUPPORT_SHA = "29686a79f248405192c25815552e36f611ece3e65d0aa8aff0dee8d79d8d6c53"
NOVELTY = Path("results/high_volatility_ehlers_laguerre_rsi_premium_sponsorship_reentry_relay_gross9_novelty_2026-08-16.json")
NOVELTY_SHA = "bb661e4fb717c7864d54404e865961fb3a308b3d6b7a65807a1c9740842fc9f2"
CLOCK = Path("data/high_volatility_ehlers_laguerre_rsi_premium_sponsorship_reentry_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "089a1864c3e92c1dcdbc3166eb105eacbbd136326298e63347369051efd26fce"
CONTROL_DIR = Path("data/high_volatility_ehlers_laguerre_rsi_premium_sponsorship_reentry_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_ehlers_laguerre_rsi_premium_sponsorship_reentry_relay_economic_evaluator_freeze_2026-08-16.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_ehlers_laguerre_rsi_premium_sponsorship_reentry_relay_{stage}_economics_2026-08-16.json")
    for stage in STAGES
}
CONTROLS = ("no_premium_sponsorship_gate", "no_variation_gate", "outward_crossing", "one_bar_stale_reentry", "direction_flip")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVELRSIPSC frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVELRSIPSC novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvelrsi_psc_24_sequential_economics_v1", "policy_id": POLICY_ID,
