#!/usr/bin/env python3
"""One-shot evaluator for the frozen 1x RV20 liquidation reversal.

The pre-2024-selected Q75/hold9/stop4/take4 two-sided cell is replayed exactly
at 1.0x.  Only its 2024 Gross9 weight may be selected; future values remain
closed unless that selection succeeds, and then may only veto the frozen
cell/1x/weight tuple.
"""
...
PREREGISTRATION = Path(
    "results/rv20_asymmetric_liquidation_reversal_fixed1x_successor_preregistration_2026-08-08.json"
)
EXPECTED_PREREGISTRATION_SHA256 = (
    "5a24e78193d3d80e3df50c0b52eb665e320e2f4a6bf3e0a72b7d3b671d5c9b82"
)
OUTPUT = Path("results/rv20_asymmetric_liquidation_reversal_fixed1x_successor_evaluation_2026-08-08.json")
REPORT = Path("docs/rv20-asymmetric-liquidation-reversal-fixed1x-successor-evaluation-2026-08-08.md")
ATTEMPT = Path(
    "results/rv20_asymmetric_liquidation_reversal_fixed1x_successor_evaluation_attempt_consumed_2026-08-08.json"
)
...
CANDIDATE = "rv20_asymmetric_liquidation_reversal_fixed1x_successor"
...
INPUT_SHA256 = {
    ...
    "pre2024_selection": "d54ef5eb6a895c16ebea337294bb9b5b2ff0f496e0713086e72e5129a56f4c2f",
    "predecessor_terminal_failure": "7ca8cf391f7c8a083dc7211ac7d31074d2a4656ab1cb6fb9efea43506670882d",
}
...
FROZEN_CELL = Cell(9, 0.75, "both", 0.04, 0.04)
FIXED_LEVERAGE = 1.0
...
def load_preregistration(path: str | Path = PREREGISTRATION) -> dict[str, Any]:
    ...
    if payload.get("schema") != "rllm.rv20-asymmetric-liquidation-reversal-fixed1x-successor.preregistration.v1":
        raise RuntimeError("unexpected RV20 preregistration schema")
    if payload.get("status") != "FROZEN_SUCCESSOR_BEFORE_2024_CONFIRMATION_INSPECTION":
    ...
    if (
        ...
        or source.get("source_verdict") != "REJECT_NO_LEVERAGE"
    ):
...
def _execution_config(
    ...
    return ExecutionConfig(
        ...
        output="/tmp/no_write_rv20_asymmetric_liquidation_reversal_fixed1x.json",
        manifest_output="/tmp/no_write_rv20_asymmetric_liquidation_reversal_fixed1x_manifest.json",
...
def evaluate_frozen_protocol(
    ...
    if selected_weight is None:
        return {
            "schema": "rllm.rv20-asymmetric-liquidation-reversal-fixed1x-successor.evaluation.v1",
            "preregistration_sha256": EXPECTED_PREREGISTRATION_SHA256,
