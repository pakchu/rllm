"""Sequential strict economics for frozen HVDCSATQA-8."""
...
PREREG = Path("results/high_volatility_directional_change_scarcity_ticket_quote_acceleration_relay_preregistration_2026-08-16.json")
PREREG_SHA = "e924238dfb8196fd02d5332190b8ed42a1853dd5caa6497c830c6670ea0b5c6c"
SUPPORT = Path("results/high_volatility_directional_change_scarcity_ticket_quote_acceleration_relay_support_2026-08-16.json")
SUPPORT_SHA = "20ba28033d9c6633b3cd7c199c4a9ddd8e4d21478b173bdd4ed3ab9b86529a3d"
NOVELTY = Path("results/high_volatility_directional_change_scarcity_ticket_quote_acceleration_relay_gross9_novelty_2026-08-16.json")
NOVELTY_SHA = "892ce4a646de0af632c036b46d4619d89d1047b0068e36b2433d94d337166f6f"
CLOCK = Path("data/high_volatility_directional_change_scarcity_ticket_quote_acceleration_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "19047421fbe39de6efa6e7a7a39b5fe5fac6ccae044643cc4ab105de464c3ecb"
CONTROL_DIR = Path("data/high_volatility_directional_change_scarcity_ticket_quote_acceleration_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_directional_change_scarcity_ticket_quote_acceleration_relay_economic_evaluator_freeze_2026-08-16.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_directional_change_scarcity_ticket_quote_acceleration_relay_{stage}_economics_2026-08-16.json")
    for stage in STAGES
}
CONTROLS = ("no_joint_ticket_quote_acceleration_gate", "no_directional_change_scarcity_tail", "no_variation_gate", "raw_directional_changes_at_most_478", "one_block_stale_geometry", "direction_flip", "forced_long")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVDCSATQA frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVDCSATQA novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvdcsatqa_8_sequential_economics_v1", "policy_id": POLICY_ID,
