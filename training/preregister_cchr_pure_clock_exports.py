...
PROTOCOL_VERSION = "cchr_pure_clock_export_preregistration_v1"
POLICY_ID = "CCHR-288"
...
PREREGISTRATION_OUTPUTS = {
    "pdlh": Path("results/cchr_pdlh_pure_clock_preregistration_2026-07-21.json"),
    "dtv": Path("results/cchr_dtv_pure_clock_preregistration_2026-07-21.json"),
    "far": Path("results/cchr_far_pure_clock_preregistration_2026-07-21.json"),
    "live": Path(
        "results/cchr_live_portfolio_pure_clock_preregistration_2026-07-21.json"
    ),
}
