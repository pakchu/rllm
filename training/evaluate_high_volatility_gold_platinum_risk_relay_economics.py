"""Sequential strict economics for frozen HVAUPTR-24."""
...
PREREG = Path("results/high_volatility_gold_platinum_risk_relay_preregistration_2026-08-11.json")
PREREG_SHA = "5ac24d3b4bcccd67a4436fb272b90d400a3e8260be86b4e3b4ceff925e4c070b"
SUPPORT = Path("results/high_volatility_gold_platinum_risk_relay_support_2026-08-11.json")
SUPPORT_SHA = "a6039c64a783807ce89b1802de851ae778ce3aa643081c8f8453ffebcfc87846"
NOVELTY = Path("results/high_volatility_gold_platinum_risk_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "3324890a0e8d95c61deb7032016f064beda7e415d842125b030375988f037df8"
CLOCK = Path("data/high_volatility_gold_platinum_risk_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "72abad53b45edd6c6312a15438dd82ff32e98a0c8d2492d11af4099a9106585c"
CONTROL_DIR = Path("data/high_volatility_gold_platinum_risk_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_gold_platinum_risk_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_gold_platinum_risk_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVAUPTR frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVAUPTR novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvauptr_24_sequential_economics_v1", "policy_id": POLICY_ID,
