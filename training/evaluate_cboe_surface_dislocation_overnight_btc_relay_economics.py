"""Sequential strict economics for frozen CVSDR-6."""
...
PREREG = Path("results/cboe_surface_dislocation_overnight_btc_relay_preregistration_2026-08-08.json")
PREREG_SHA = "243a59bcf260b5510802cd9254f1610ba5802e350ecf5b843a06a8db379ca2a7"
SUPPORT = Path("results/cboe_surface_dislocation_overnight_btc_relay_support_2026-08-08.json")
SUPPORT_SHA = "625e2ed5839fa77202513c264bd5205ee80bc0745b61ff749f8b9742acfb9350"
NOVELTY = Path("results/cboe_surface_dislocation_overnight_btc_relay_gross9_novelty_2026-08-08.json")
NOVELTY_SHA = "be964cc622500292938eb26e800e5262053ed8731839f7d260c4438213a09540"
CLOCK = Path("data/cboe_surface_dislocation_overnight_btc_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "5858ed42548f6c65344d160001d5f97e3935c1d6bd97a8350b93180c95c03cdf"
CONTROL_DIR = Path("data/cboe_surface_dislocation_overnight_btc_relay_controls_2023_2026")
FREEZE = Path("results/cboe_surface_dislocation_overnight_btc_relay_economic_evaluator_freeze_2026-08-08.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/cboe_surface_dislocation_overnight_btc_relay_{stage}_economics_2026-08-08.json")
    for stage in STAGES
}
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("CVSDR frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("CVSDR novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "cvsdr_6_sequential_economics_v1", "policy_id": POLICY_ID,
