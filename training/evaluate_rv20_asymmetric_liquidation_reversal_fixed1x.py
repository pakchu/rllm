...
PREREGISTRATION = Path(
    "results/rv20_asymmetric_liquidation_reversal_fixed1x_preregistration_2026-08-08.json"
)
EXPECTED_PREREGISTRATION_SHA256 = (
    "dd7000dca7a17384983d87ecbe2922bae9eda0f14bde6c6a74ce2624dc3dd441"
)
OUTPUT = Path("results/rv20_asymmetric_liquidation_reversal_fixed1x_evaluation_2026-08-08.json")
REPORT = Path("docs/rv20-asymmetric-liquidation-reversal-fixed1x-evaluation-2026-08-08.md")
ATTEMPT = Path(
    "results/rv20_asymmetric_liquidation_reversal_fixed1x_evaluation_attempt_consumed_2026-08-08.json"
)
...
CANDIDATE = "rv20_asymmetric_liquidation_reversal_fixed1x"
...
def load_preregistration(path: str | Path = PREREGISTRATION) -> dict[str, Any]:
    ...
    if payload.get("schema") != "rllm.rv20-asymmetric-liquidation-reversal-fixed1x.preregistration.v1":
...
def evaluate_frozen_protocol(
    ...
    if selected_weight is None:
        return {
            "schema": "rllm.rv20-asymmetric-liquidation-reversal-fixed1x.evaluation.v1",
            "preregistration_sha256": EXPECTED_PREREGISTRATION_SHA256,
