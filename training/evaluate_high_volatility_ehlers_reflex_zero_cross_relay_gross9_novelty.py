...
from training import preregister_high_volatility_ehlers_reflex_zero_cross_relay as registration
...
OUTPUT = Path("results/high_volatility_ehlers_reflex_zero_cross_relay_gross9_novelty_2026-08-11.json")
LIMITS = {
