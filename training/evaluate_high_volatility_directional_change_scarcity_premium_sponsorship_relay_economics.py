"""Sequential strict economics for frozen HVDCSPSC-8."""
...
PREREG = Path("results/high_volatility_directional_change_scarcity_premium_sponsorship_relay_preregistration_2026-08-16.json")
PREREG_SHA = "74c490e6d4e22336ba004f0dceacf31792205796a606c88ab4ae70a05babaaad"
SUPPORT = Path("results/high_volatility_directional_change_scarcity_premium_sponsorship_relay_support_2026-08-16.json")
SUPPORT_SHA = "cc377a379688c595ec9f797caa298af759bdb338686dec1de965448d76989404"
NOVELTY = Path("results/high_volatility_directional_change_scarcity_premium_sponsorship_relay_gross9_novelty_2026-08-16.json")
NOVELTY_SHA = "ec1759f11381e8ae2f30a4e448c8a26f00e4290304334d953bb1a4f5f55d41e8"
CLOCK = Path("data/high_volatility_directional_change_scarcity_premium_sponsorship_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "61e0261fa43ab6408ec08c547ec77d5e3e82fc08b53577753be9a6c164998ccc"
CONTROL_DIR = Path("data/high_volatility_directional_change_scarcity_premium_sponsorship_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_directional_change_scarcity_premium_sponsorship_relay_economic_evaluator_freeze_2026-08-16.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_directional_change_scarcity_premium_sponsorship_relay_{stage}_economics_2026-08-16.json")
    for stage in STAGES
}
CONTROLS = ("no_premium_sponsorship_gate", "no_directional_change_scarcity_tail", "no_variation_gate", "raw_directional_changes_at_most_478", "one_block_stale_geometry", "direction_flip", "forced_long")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVDCSPSC frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVDCSPSC novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvdcs_psc_8_sequential_economics_v1", "policy_id": POLICY_ID,
