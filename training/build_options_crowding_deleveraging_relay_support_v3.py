"""Build outcome-blind OCDR-12B clocks and source-support evidence."""
...
from training import preregister_options_crowding_deleveraging_relay_v3 as prereg


SOURCE_DIR = Path("data/options_crowding_deleveraging_relay_sources_v3_2023_2026")
MANIFEST = SOURCE_DIR / "manifest.json"
OUTPUT_CLOCK = Path("data/options_crowding_deleveraging_relay_clocks_v3_2023_2026.csv.gz")
OUTPUT_CONTROLS = Path("data/options_crowding_deleveraging_relay_controls_v3_2023_2026")
OUTPUT_RESULT = Path("results/options_crowding_deleveraging_relay_support_v3_2026-08-08.json")
...
def run() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "ocdr_12b_source_support_v1",
        "policy_id": "OCDR-12B",
