"""Outcome-blind preregistration for HVCATAIR-8."""
...
DEFAULT_OUTPUT = Path("results/high_volatility_causal_average_ticket_acceleration_inventory_relay_preregistration_2026-08-16.json")
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_causal_average_ticket_acceleration_inventory_relay_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            "claim": "When BTC perpetual average quote ticket size accelerates unusually from the first to the second four-hour half, realized variation is elevated, open interest expands, and the completed eight-hour return is nonzero, increasingly large transactions and fresh leveraged inventory sponsor the completed price direction for eight hours.",
            "side": "strict sign of the completed eight-hour BTC perpetual return",
            "why_distinct": "HVCATAIR uses within-cycle acceleration in quote turnover per transaction, not turnover or transaction count alone, plus exact OI expansion and variation. It reuses neither prior event set nor control and uses no taker-flow sign, spot source, ETH, funding, premium-index, fitted outcome, or promoted control.",
        ...
        "stopping_rule": "terminal first failure; no OI endpoint or expansion rule, average-ticket acceleration formula, acceleration or variation history, side, clock, hold, subset, threshold, comparator, or control repair",
    }
