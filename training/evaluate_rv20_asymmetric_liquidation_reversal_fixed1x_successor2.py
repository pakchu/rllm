...
PREREGISTRATION = Path(
    "results/rv20_asymmetric_liquidation_reversal_fixed1x_successor2_preregistration_2026-08-08.json"
)
EXPECTED_PREREGISTRATION_SHA256 = (
    "fb7b536cf4ae5d1dcc98fd095118ac84206dc89035d698cc13a5bec640ec2854"
)
OUTPUT = Path("results/rv20_asymmetric_liquidation_reversal_fixed1x_successor2_evaluation_2026-08-08.json")
REPORT = Path("docs/rv20-asymmetric-liquidation-reversal-fixed1x-successor2-evaluation-2026-08-08.md")
ATTEMPT = Path(
    "results/rv20_asymmetric_liquidation_reversal_fixed1x_successor2_evaluation_attempt_consumed_2026-08-08.json"
)
...
CANDIDATE = "rv20_asymmetric_liquidation_reversal_fixed1x_successor2"
...
INPUT_SHA256 = {
    ...
    "predecessor_terminal_failure": "9d239d786abd58775497830734428fd5f4bd8f0e8c17bcb4b64514e3c2529ec4",
}
...
def load_preregistration(path: str | Path = PREREGISTRATION) -> dict[str, Any]:
    ...
    if payload.get("schema") != "rllm.rv20-asymmetric-liquidation-reversal-fixed1x-successor2.preregistration.v1":
        raise RuntimeError("unexpected RV20 preregistration schema")
    if payload.get("status") != "FROZEN_SUCCESSOR2_BEFORE_2024_CONFIRMATION_INSPECTION":
...
def evaluate_frozen_protocol(
    ...
    if selected_weight is None:
        return {
            "schema": "rllm.rv20-asymmetric-liquidation-reversal-fixed1x-successor2.evaluation.v1",
            "preregistration_sha256": EXPECTED_PREREGISTRATION_SHA256,
