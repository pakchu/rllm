"""Sequential strict economics for frozen HVELRSI-24."""
...
POLICY_ID = "HVELRSI-24"
BAR = pd.Timedelta(minutes=5)
LEVERAGE = 0.5
BASE_COST = 0.0006
STRESS_COST = 0.0010
ENV_FILE = "/home/pakchu/rllm/.env"
PREREG = Path("results/high_volatility_ehlers_laguerre_rsi_reentry_relay_preregistration_2026-08-11.json")
PREREG_SHA = "cc150b6e6bd11055e8792e80787b9631a36ffbbfb8fef916122191a2fc71100c"
SUPPORT = Path("results/high_volatility_ehlers_laguerre_rsi_reentry_relay_support_2026-08-11.json")
SUPPORT_SHA = "3828aa9325b8c569fc351542975c99e8236d44addd926854557bb013efce4c48"
NOVELTY = Path("results/high_volatility_ehlers_laguerre_rsi_reentry_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "1e29e55bf572fa090fa1ee44501c6b4fc9a2557ac17671444d43923fc4eb8206"
CLOCK = Path("data/high_volatility_ehlers_laguerre_rsi_reentry_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "e764671cefc9eb8724524533614e163dfc40e4b4767c933b4255420d70d5e5e7"
CONTROL_DIR = Path("data/high_volatility_ehlers_laguerre_rsi_reentry_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_ehlers_laguerre_rsi_reentry_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_ehlers_laguerre_rsi_reentry_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
CONTROLS = ("no_variation_gate", "outward_crossing", "one_bar_stale_reentry", "direction_flip")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVELRSI frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVELRSI novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvelrsi_24_sequential_economics_v1", "policy_id": POLICY_ID,
