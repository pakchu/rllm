"""Source-only exact-clock intersection for frozen HVCELVOIS-8."""
...
RIGHT=Path("data/high_volatility_cross_alt_serial_persistence_open_interest_sponsorship_relay_clocks_2023_2026.csv.gz")
CLOCK=Path("data/high_volatility_caspc_ehlers_oi_joint_sponsorship_clocks_2023_2026.csv.gz")
RESULT=Path("results/high_volatility_caspc_ehlers_oi_joint_sponsorship_support_2026-08-16.json")
...
def run():
 ...
 left,right=load(LEFT,"HVCELV"),load(RIGHT,"HVCASPCOIS")
 ...
 core={"protocol_version":"hvcelvois_8_source_support_v1","policy_id":prereg.POLICY_ID,"preregistration":{"path":str(prereg.DEFAULT_OUTPUT),"sha256":PREREG_SHA,"manifest_hash":registration["manifest_hash"]},"component_clock_rows_opened":{"HVCELV-8":len(left),"HVCASPCOIS-8":len(right)},"component_clock_hashes":{"HVCELV-8":sha(LEFT),"HVCASPCOIS-8":sha(RIGHT)},"completed_preentry_sources_opened":True,"postentry_return_pnl_execution_price_opened":False,"held_interval_funding_values_opened":False,"gross9_rows_opened":False,"clock":{"path":str(CLOCK),"sha256":sha(CLOCK),"rows":len(clock)},"controls":{},"support":support,"support_checks":checks,"support_passed":passed,"advance_to_gross9_novelty":passed,"advance_to_economic_outcomes":False,"decision":"pass_to_novelty" if passed else "terminal_source_support_reject"}
