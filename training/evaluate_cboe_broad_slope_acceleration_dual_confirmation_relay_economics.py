"""Sequential strict economics for frozen CVBDMR-6."""
...
PREREG = Path("results/cboe_broad_slope_acceleration_dual_confirmation_relay_preregistration_2026-08-08.json")
PREREG_SHA = "2b1c0508afbc06282051e808f9026cf1c9867588aa444a42ca402b421c56dc33"
SUPPORT = Path("results/cboe_broad_slope_acceleration_dual_confirmation_relay_support_2026-08-08.json")
SUPPORT_SHA = "018246e128aac3314312ab100fea5740d091d27c018166879e65ef34e36450d7"
NOVELTY = Path("results/cboe_broad_slope_acceleration_dual_confirmation_relay_gross9_novelty_2026-08-08.json")
NOVELTY_SHA = "7742eaf52053ce5a9a7bfcd9b30063a6f58dc38dd7c5a1be88f1234a1b5f2400"
CLOCK = Path("data/cboe_broad_slope_acceleration_dual_confirmation_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "d6e658de2733aef6e90ff9935514e649423f846b0bddcfdf8693c4a2c73c1771"
CONTROL_DIR = Path("data/cboe_broad_slope_acceleration_dual_confirmation_relay_controls_2023_2026")
FREEZE = Path("results/cboe_broad_slope_acceleration_dual_confirmation_relay_economic_evaluator_freeze_2026-08-08.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/cboe_broad_slope_acceleration_dual_confirmation_relay_{stage}_economics_2026-08-08.json")
    for stage in STAGES
}
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("CVBDMR frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("CVBDMR novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "cvbdmr_6_sequential_economics_v1", "policy_id": POLICY_ID,
