"""Sequential strict economics for frozen HVCAMLC-8."""
...
PREREG = Path("results/high_volatility_cross_alt_magnitude_leadership_continuation_preregistration_2026-08-16.json")
PREREG_SHA = "016b0dc79fe6d85dd5dd6d09a2a7d16acc243353efd6f5859ae1ad8c171ef059"
SUPPORT = Path("results/high_volatility_cross_alt_magnitude_leadership_continuation_support_2026-08-16.json")
SUPPORT_SHA = "ed3ecb75426f9179018be9b48cd95f07529e033cbf74b6e052cacc0f9329bf49"
NOVELTY = Path("results/high_volatility_cross_alt_magnitude_leadership_continuation_gross9_novelty_2026-08-16.json")
NOVELTY_SHA = "d1937ba069d087b1d3db04a45f4d21ff40dbb746785c073b5e75cdfd5f859f96"
CLOCK = Path("data/high_volatility_cross_alt_magnitude_leadership_continuation_clocks_2023_2026.csv.gz")
CLOCK_SHA = "36052d8b75c71a0e50dcb167372977011fcd394e0dbda94a6ba3a1115f908c82"
CONTROL_DIR = Path("data/high_volatility_cross_alt_magnitude_leadership_continuation_controls_2023_2026")
FREEZE = Path("results/high_volatility_cross_alt_magnitude_leadership_continuation_economic_evaluator_freeze_2026-08-16.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_cross_alt_magnitude_leadership_continuation_{stage}_economics_2026-08-16.json")
    for stage in STAGES
}
CONTROLS = ()
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVCAMLC frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVCAMLC novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvcamlc_8_sequential_economics_v1", "policy_id": POLICY_ID,
