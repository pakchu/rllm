"""Outcome-blind preregistration for CLIRR-6."""
...
POLICY_ID = "CLIRR-6"
DEFAULT_OUTPUT = Path(
    "results/confirmation_ladder_impulse_reversal_relay_preregistration_2026-08-09.json"
)
...
def build() -> dict[str, Any]:
    core = {
        "protocol_version": "confirmation_ladder_impulse_reversal_relay_v1",
        "policy_id": POLICY_ID,
        ...
        "singleton": True,
        "mechanism": {
            "claim": "When BTC return over the last three of six canonical confirmation intervals reverses the first three and dominates it by an unusually large magnitude ratio, block-time price discovery has transferred direction; follow the late-ladder reversal for six elapsed hours.",
            "side": "strict sign of the sum of confirmation-interval returns 4 through 6",
            "why_distinct": "CLIRR uses the disjoint opposite-sign early/late quadrant plus late dominance inside one external block-time ladder. CLBHAR required same-sign acceleration. It does not use CLDCR cumulative q90, five-of-six coherence, fixed-clock momentum, volume, flow, funding, premium, OI, or a prior control.",
            "volatile_market_target": "a prior-tail late/early ratio after strict sign reversal identifies dominant volatile direction transfer; causal RV20 q90 remains only a later audit",
        ...
        "features": {
            ...
            "direction_reversal": "strict sign(E)=-strict sign(L)",
            ...
            "eligible_state": "direction reversal true and A rank>=0.80",
        ...
        "diagnostic_controls": {
            "definitions": {
                "direction_reversal_only": "opposite-sign early and late returns onset without acceleration rank",
        ...
        "research_boundary": {
            "prior_same_sign_acceleration_outcomes_known": True,
            "exact_clirr_incidence_known": False,
            "exact_clirr_outcomes_known": False,
