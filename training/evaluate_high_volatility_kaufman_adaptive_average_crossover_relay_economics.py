"""Sequential strict economics for frozen HVKAMA-24."""
...
PREREG = Path("results/high_volatility_kaufman_adaptive_average_crossover_relay_preregistration_2026-08-11.json")
PREREG_SHA = "af9593c517425d013e51e767d8f144d149b9717be481c88a5f27b66984c6a142"
SUPPORT = Path("results/high_volatility_kaufman_adaptive_average_crossover_relay_support_2026-08-11.json")
SUPPORT_SHA = "9adaf8ceb28ef3c84f9758ebd161a76cf7c297ff332bb3646165f3f609e019ea"
NOVELTY = Path("results/high_volatility_kaufman_adaptive_average_crossover_relay_gross9_novelty_2026-08-11.json")
NOVELTY_SHA = "e7e4ec4b10d529330117e91723a1ed873b3e386d33de1003bdd0d00c2b096d97"
CLOCK = Path("data/high_volatility_kaufman_adaptive_average_crossover_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "b4ac3769319006bbe45c7bda23a2124ad316793dfe4b3282ed9e14e066212435"
CONTROL_DIR = Path("data/high_volatility_kaufman_adaptive_average_crossover_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_kaufman_adaptive_average_crossover_relay_economic_evaluator_freeze_2026-08-11.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_kaufman_adaptive_average_crossover_relay_{stage}_economics_2026-08-11.json")
    for stage in STAGES
}
CONTROLS = ("no_variation_gate", "fixed_slow_ema_crossover", "one_bar_stale_crossover", "direction_flip")
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("HVKAMA frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("HVKAMA novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvkama_24_sequential_economics_v1", "policy_id": POLICY_ID,
