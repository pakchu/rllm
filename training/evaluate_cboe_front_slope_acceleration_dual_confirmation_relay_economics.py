"""Sequential strict economics for frozen CVFDMR-6."""
...
PREREG = Path("results/cboe_front_slope_acceleration_dual_confirmation_relay_preregistration_2026-08-08.json")
PREREG_SHA = "cd9e4fc2fcb9527e7363f33b6c183cfd47b7b56c12f189d871cd639ba0fd28ab"
SUPPORT = Path("results/cboe_front_slope_acceleration_dual_confirmation_relay_support_2026-08-08.json")
SUPPORT_SHA = "d43f819b78c8b5009b46b4bc9599197b8390c6a725eea4a03b873e6da80083b2"
NOVELTY = Path("results/cboe_front_slope_acceleration_dual_confirmation_relay_gross9_novelty_2026-08-08.json")
NOVELTY_SHA = "9e96149733715789e327a8e4a8271b381641ce379e947f2705a875e5daa26b67"
CLOCK = Path("data/cboe_front_slope_acceleration_dual_confirmation_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "04e077239a23e70966d94b13ad7fa8a81f41fe8f3cc881b1728432dce4b6cc24"
CONTROL_DIR = Path("data/cboe_front_slope_acceleration_dual_confirmation_relay_controls_2023_2026")
FREEZE = Path("results/cboe_front_slope_acceleration_dual_confirmation_relay_economic_evaluator_freeze_2026-08-08.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/cboe_front_slope_acceleration_dual_confirmation_relay_{stage}_economics_2026-08-08.json")
    for stage in STAGES
}
...
def verify(stage: str) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if any(sha256(path) != digest for path, digest in expected):
        raise RuntimeError("CVFDMR frozen predecessor hash drift")
    ...
    if novelty.get("advance_to_economic_outcomes") is not True or novelty.get("evidence_boundary", {}).get("outcomes_opened") is not False:
        raise RuntimeError("CVFDMR novelty did not authorize economics")
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "cvfdmr_6_sequential_economics_v1", "policy_id": POLICY_ID,
