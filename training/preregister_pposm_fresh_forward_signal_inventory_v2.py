...
POLICY_ID = "pposm_fresh_forward_signal_inventory_v2"
PROJECT_ROOT = Path(__file__).resolve().parents[1]
SOURCE_ROOT = Path("/home/pakchu/rllm")
DEFAULT_OUTPUT = Path(
    "results/pposm_fresh_forward_signal_inventory_v2_preregistration_2026-09-05.json"
)
...
SYMBOL = "BTCUSDT"
INTERVAL = "1m"
V1_FAILURE_ARTIFACT = Path("results/pposm_fresh_forward_signal_inventory_2026-09-05.json")
V1_FAILURE_ARTIFACT_SHA256 = "1fa032f039cfac32ffd4bef4b7c6edf4eb77c114e5c5ebb941e7864205d9fe45"
SOURCE_DIAGNOSTIC_ARTIFACT = Path("results/pposm_funding_alias_source_diagnostic_2026-09-05.json")
SOURCE_DIAGNOSTIC_ARTIFACT_SHA256 = "c56af6dc39ff07b95483e953cbfa5619b07b93e2e653ef6e1ef405058c1f3396"
SOURCE_DIAGNOSTIC_RESULT_HASH = "a8c07ea787cd99aa233ad3ad665a2d0e232fce7f49cecc8c7daf5309dd9f66e9"
FUNDING_ALIAS_POLICY = {
    "alias_grouping": "sort by raw funding_time; group only adjacent rows whose timestamp delta from the previous row is <=100ms",
    "max_cluster_span_ms": 100,
    "canonical_timestamp": "latest raw timestamp in the accepted near-alias cluster; no snapping to cadence",
    "required_exact_equal_columns": ["funding_rate", "mark_price"],
    "reject": ["exact_duplicate_timestamp", "malformed_timestamp", "nonfinite_funding_rate_or_mark_price", "unequal_values_within_near_alias_cluster", "cluster_span_gt_100ms"],
    "preserve_events_separated_by_at_least": "1min",
}
...
COMPLETENESS_POLICY: dict[str, object] = {
    ...
    "funding": {"source": "funding_rates_binance", "time_column": "funding_time/date", "canonicalization": FUNDING_ALIAS_POLICY, "start": QUERY_START, "end_exclusive": FORWARD_END_EXCLUSIVE, "exact_event_grid": False, "allowed_dynamic_intervals": ["1h", "4h", "8h", "other<=12h"], "duplicates_allowed": False, "required_finite_columns": ["funding_rate", "mark_price"], "query_start_max_initial_age": "12h", "last_decision_max_age": "12h", "max_consecutive_gap": "12h", "not_vendor_global_completeness_proof": True},
...
def code_hashes() -> dict[str, str]:
    builder_path = PROJECT_ROOT / "training/build_pposm_fresh_forward_signal_inventory_v2.py"
    builder_functions = (
        ...
        "_expect_contract_value",
        "_canonical_decimal_string",
        "_canonical_hash_cell",
        "_decimal_from_raw",
        "_funding_decimal_columns",
        "canonicalize_funding_aliases",
    ...
    hashes = {
        ...
        "feature_set_policy": sha256_bytes(canonical_json({"state": STATE_FEATURE_COLUMNS, "active": ACTIVE_FEATURE_COLUMNS, "parity": PARITY_FEATURE_COLUMNS, "funding_alias_policy": FUNDING_ALIAS_POLICY}).encode()),
        "v1_failure_artifact": sha256_file(V1_FAILURE_ARTIFACT),
        "funding_alias_source_diagnostic_artifact": sha256_file(SOURCE_DIAGNOSTIC_ARTIFACT),
