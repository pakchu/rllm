"""Sequential strict economics for frozen HVDRA-24."""
...
PREREG = Path("results/high_volatility_doi_research_attention_relay_preregistration_2026-08-12.json")
PREREG_SHA = "edab5cf88d7cdd2b90b58aa938a4e09e5c58aeae27e3dd646b42bf2c129ef3a4"
SUPPORT = Path("results/high_volatility_doi_research_attention_relay_support_2026-08-12.json")
SUPPORT_SHA = "f0e03ed636f984253bb11e2bcd0b93dd4731b3ad7128c3585437a73cf13c82ea"
NOVELTY = Path("results/high_volatility_doi_research_attention_relay_gross9_novelty_2026-08-12.json")
NOVELTY_SHA = "7e5f9f2f4fdcc78bb8cb4d963230b036a98d87b6f692eae19f5d611a21dcb8d9"
CLOCK = Path("data/high_volatility_doi_research_attention_relay_clocks_2023_2026.csv.gz")
CLOCK_SHA = "009843b2c2d027b66851748da321495ab65fd285eccea9d44676d595584d514e"
CONTROL_DIR = Path("data/high_volatility_doi_research_attention_relay_controls_2023_2026")
FREEZE = Path("results/high_volatility_doi_research_attention_relay_economic_evaluator_freeze_2026-08-12.json")
STAGES = {
...
OUTPUTS = {
    stage: Path(f"results/high_volatility_doi_research_attention_relay_{stage}_economics_2026-08-12.json")
    for stage in STAGES
}
...
def run(stage: str, output: Path | None = None) -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "hvdra_24_sequential_economics_v1", "policy_id": POLICY_ID,
