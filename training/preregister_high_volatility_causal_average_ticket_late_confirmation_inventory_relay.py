"""Outcome-blind preregistration for HVCATLIR-8."""
...
POLICY_ID = "HVCATLIR-8"
DEFAULT_OUTPUT = Path("results/high_volatility_causal_average_ticket_late_confirmation_inventory_relay_preregistration_2026-08-16.json")
...
def build() -> dict[str, Any]:
    ...
    core = {
        "protocol_version": "high_volatility_causal_average_ticket_late_confirmation_inventory_relay_v1",
        "policy_id": POLICY_ID,
        ...
        "mechanism": {
            "claim": "When BTC perpetual average quote ticket size accelerates unusually, the final two completed hours confirm the full eight-hour direction, realized variation is elevated, and open interest expands, late price acceptance and fresh leveraged large transactions sponsor continuation for eight hours.",
            "side": "strict sign of the completed eight-hour BTC perpetual return",
            "why_distinct": "HVCATLIR combines average-ticket acceleration with strict final-two-hour price-direction confirmation, exact OI expansion, and variation. No prior composite event set or control is reused; it uses no taker-flow sign, spot, alt, funding, premium-index, fitted outcome, or promoted control.",
        ...
        "features": {
            ...
            "late_confirmation": "strict sign of final_two_hour_return equals strict sign of completed_return",
            ...
            "eligible": "exact coherent completed perpetual cycle, positive average-ticket acceleration, nonzero completed and final-two-hour returns with strict sign agreement, two exact OI endpoints with strict expansion, and both average-ticket-acceleration and variation ranks pass at D; no taker-flow sign, spot source, funding, range, premium-index, alt, or post-decision condition",
            "no_imputation": True,
        },
        "clock": {
        ...
        "stopping_rule": "terminal first failure; no OI endpoint or expansion rule, average-ticket acceleration formula, final-two-hour confirmation, rank histories, side, clock, hold, subset, threshold, comparator, or control repair",
    }
